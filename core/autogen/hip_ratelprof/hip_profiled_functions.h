...
typedef enum {
	...
	HIP_API_ID_hipDestroySurfaceObject,    HIP_API_ID_NB_FUNCTION,
    HIP_API_ID_UNKNOWN,
} hip_api_id_t;
...
static inline hip_api_id_t get_hip_funid_by_name(const char* name) {
	...
	else if (strcmp(name, "hipGetDeviceProperties") == 0) return HIP_API_ID_hipGetDeviceProperties;
	...
	else if (strcmp(name, "hipChooseDevice") == 0) return HIP_API_ID_hipChooseDevice;
