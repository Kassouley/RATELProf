 ...
 * - `rear`: The index of the rear element in the queue. This is the position where the next element will be pushed.
...
typedef struct {
    ...
    size_t front;
    /** Index of the rear element. This is the position where the next element will be pushed. */
    size_t rear;
