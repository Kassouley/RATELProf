...
// void msgpack_encode_bin(msgpack_buffer_t *buf, const int *data, size_t size);
...
int msgpack_reverse_encode_bool(msgpack_buffer_t *buf, bool value);
int msgpack_reverse_encode_nil(msgpack_buffer_t *buf);
int msgpack_reverse_encode_string(msgpack_buffer_t *buf, const char *str);
// void msgpack_reverse_encode_bin(msgpack_buffer_t *buf, const int *data, size_t size);
