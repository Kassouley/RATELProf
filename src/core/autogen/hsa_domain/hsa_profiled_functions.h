...
#define HSA_FUNCTION_CALL_RET(ret_type, func, ...) \
	clock_gettime(CLOCK_MONOTONIC, &__hsa_activity->start_time); \
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_iterate_configuration(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_iterate_configuration.agent = (hsa_agent_t)agent; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_iterate_configuration.configuration_callback = (hsa_ven_amd_pcs_iterate_configuration_callback_t)configuration_callback; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_iterate_configuration.callback_data = (void*)callback_data; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_start(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_start.pc_sampling = (hsa_ven_amd_pcs_t)pc_sampling; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_flush(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_flush.pc_sampling = (hsa_ven_amd_pcs_t)pc_sampling; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_create(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.agent = (hsa_agent_t)agent; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.method = (hsa_ven_amd_pcs_method_kind_t)method; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.units = (hsa_ven_amd_pcs_units_t)units; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.interval = (size_t)interval; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.latency = (size_t)latency; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.buffer_size = (size_t)buffer_size; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.data_ready_callback = (hsa_ven_amd_pcs_data_ready_callback_t)data_ready_callback; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.client_callback_data = (void*)client_callback_data; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create.pc_sampling = (hsa_ven_amd_pcs_t*)pc_sampling; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_stop(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_stop.pc_sampling = (hsa_ven_amd_pcs_t)pc_sampling; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_create_from_id(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.pcs_id = (uint32_t)pcs_id; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.agent = (hsa_agent_t)agent; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.method = (hsa_ven_amd_pcs_method_kind_t)method; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.units = (hsa_ven_amd_pcs_units_t)units; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.interval = (size_t)interval; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.latency = (size_t)latency; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.buffer_size = (size_t)buffer_size; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.data_ready_callback = (hsa_ven_amd_pcs_data_ready_callback_t)data_ready_callback; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.client_callback_data = (void*)client_callback_data; \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_create_from_id.pc_sampling = (hsa_ven_amd_pcs_t*)pc_sampling; \
};
...
#define GET_ARGS_VALUE_hsa_amd_queue_get_info(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_amd_queue_get_info.queue = (hsa_queue_t*)queue; \
	__hsa_activity->hsa_args.hsa_amd_queue_get_info.attribute = (hsa_queue_info_attribute_t)attribute; \
	__hsa_activity->hsa_args.hsa_amd_queue_get_info.value = (void*)value; \
};
...
#define GET_ARGS_VALUE_hsa_amd_vmem_address_reserve_align(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_amd_vmem_address_reserve_align.va = (void**)va; \
	__hsa_activity->hsa_args.hsa_amd_vmem_address_reserve_align.size = (size_t)size; \
	__hsa_activity->hsa_args.hsa_amd_vmem_address_reserve_align.address = (uint64_t)address; \
	__hsa_activity->hsa_args.hsa_amd_vmem_address_reserve_align.alignment = (uint64_t)alignment; \
	__hsa_activity->hsa_args.hsa_amd_vmem_address_reserve_align.flags = (uint64_t)flags; \
};
...
#define GET_ARGS_VALUE_hsa_ven_amd_pcs_destroy(__hsa_activity) { \
	__hsa_activity->hsa_args.hsa_ven_amd_pcs_destroy.pc_sampling = (hsa_ven_amd_pcs_t)pc_sampling; \
};
...
typedef union hsa_api_args_s {
	...
	struct args_hsa_ven_amd_pcs_iterate_configuration_t hsa_ven_amd_pcs_iterate_configuration;
	...
	struct args_hsa_ven_amd_pcs_start_t hsa_ven_amd_pcs_start;
	...
	struct args_hsa_ven_amd_pcs_flush_t hsa_ven_amd_pcs_flush;
	...
	struct args_hsa_ven_amd_pcs_create_t hsa_ven_amd_pcs_create;
	...
	struct args_hsa_ven_amd_pcs_stop_t hsa_ven_amd_pcs_stop;
	...
	struct args_hsa_ven_amd_pcs_create_from_id_t hsa_ven_amd_pcs_create_from_id;
	...
	struct args_hsa_amd_queue_get_info_t hsa_amd_queue_get_info;
	...
	struct args_hsa_amd_vmem_address_reserve_align_t hsa_amd_vmem_address_reserve_align;
	...
	struct args_hsa_ven_amd_pcs_destroy_t hsa_ven_amd_pcs_destroy;
