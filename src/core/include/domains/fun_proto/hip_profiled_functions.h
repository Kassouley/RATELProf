...
typedef hipError_t (*__hipLibraryUnload_t)(hipLibrary_t library, void* return_address);
...
typedef hipError_t (*__hipStreamSetAttribute_t)(hipStream_t stream, hipLaunchAttributeID attr, const hipLaunchAttributeValue * value, void* return_address);
...
typedef hipError_t (*__hipStreamGetId_t)(hipStream_t stream, unsigned long long * streamId, void* return_address);
...
typedef hipError_t (*__hipKernelGetLibrary_t)(hipLibrary_t * library, hipKernel_t kernel, void* return_address);
...
typedef hipError_t (*__hipGraphBatchMemOpNodeSetParams_t)(hipGraphNode_t hNode, hipBatchMemOpNodeParams * nodeParams, void* return_address);
...
typedef hipError_t (*__hipGetDriverEntryPoint_t)(const char * symbol, void ** funcPtr, unsigned long long flags, hipDriverEntryPointQueryResult * driverStatus, void* return_address);
...
typedef hipError_t (*__hipGraphExecGetFlags_t)(hipGraphExec_t graphExec, unsigned long long * flags, void* return_address);
...
typedef hipError_t (*__hipMemcpyHtoD_t)(hipDeviceptr_t dst, const void * src, size_t sizeBytes, void* return_address);
...
typedef hipError_t (*__hipLaunchKernelExC_t)(const hipLaunchConfig_t * config, const void * fPtr, void ** args, void* return_address);
...
typedef hipError_t (*__hipLibraryLoadData_t)(hipLibrary_t * library, const void * code, hipJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, hipLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions, void* return_address);
...
typedef hipError_t (*__hipDeviceGetTexture1DLinearMaxWidth_t)(size_t * max_width, const hipChannelFormatDesc * desc, int device, void* return_address);
...
typedef hipError_t (*__hipMemcpy3DBatchAsync_t)(size_t numOps, struct hipMemcpy3DBatchOp * opList, size_t * failIdx, unsigned long long flags, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipLinkCreate_t)(unsigned int numOptions, hipJitOption * options, void ** optionValues, hipLinkState_t * stateOut, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D16_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned short value, size_t width, size_t height, void* return_address);
...
typedef hipError_t (*__hipLinkComplete_t)(hipLinkState_t state, void ** hipBinOut, size_t * sizeOut, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D16Async_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned short value, size_t width, size_t height, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipDrvGraphExecMemcpyNodeSetParams_t)(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const HIP_MEMCPY3D * copyParams, hipCtx_t ctx, void* return_address);
...
typedef hipError_t (*__hipStreamCopyAttributes_t)(hipStream_t dst, hipStream_t src, void* return_address);
...
typedef hipError_t (*__hipGraphNodeSetParams_t)(hipGraphNode_t node, hipGraphNodeParams * nodeParams, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D8Async_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned char value, size_t width, size_t height, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipLibraryLoadFromFile_t)(hipLibrary_t * library, const char * fileName, hipJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, hipLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions, void* return_address);
...
typedef hipError_t (*__hipGraphAddBatchMemOpNode_t)(hipGraphNode_t * phGraphNode, hipGraph_t hGraph, const hipGraphNode_t * dependencies, size_t numDependencies, const hipBatchMemOpNodeParams * nodeParams, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D8_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned char value, size_t width, size_t height, void* return_address);
...
typedef hipError_t (*__hipCtxGetApiVersion_t)(hipCtx_t ctx, unsigned int * apiVersion, void* return_address);
...
typedef hipError_t (*__hipMemPrefetchAsync_v2_t)(const void * dev_ptr, size_t count, hipMemLocation location, unsigned int flags, hipStream_t stream, void* return_address);

hipError_t i_hipLinkDestroy(hipLinkState_t state, void* return_address);
typedef hipError_t (*__hipLinkDestroy_t)(hipLinkState_t state, void* return_address);
...
typedef hipError_t (*__hipEventRecordWithFlags_t)(hipEvent_t event, hipStream_t stream, unsigned int flags, void* return_address);
...
typedef hipError_t (*__hipLibraryEnumerateKernels_t)(hipKernel_t * kernels, unsigned int numKernels, hipLibrary_t library, void* return_address);
...
typedef hipError_t (*__hipLinkAddData_t)(hipLinkState_t state, hipJitInputType type, void * data, size_t size, const char * name, unsigned int numOptions, hipJitOption * options, void ** optionValues, void* return_address);
...
typedef hipError_t (*__hipDrvGraphAddMemFreeNode_t)(hipGraphNode_t * phGraphNode, hipGraph_t hGraph, const hipGraphNode_t * dependencies, size_t numDependencies, hipDeviceptr_t dptr, void* return_address);
...
typedef hipError_t (*__hipGetDriverEntryPoint_spt_t)(const char * symbol, void ** funcPtr, unsigned long long flags, hipDriverEntryPointQueryResult * status, void* return_address);
...
typedef hipError_t (*__hipGraphExecBatchMemOpNodeSetParams_t)(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const hipBatchMemOpNodeParams * nodeParams, void* return_address);
...
typedef hipError_t (*__hipMemcpyHtoDAsync_t)(hipDeviceptr_t dst, const void * src, size_t sizeBytes, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipMemcpyBatchAsync_t)(void ** dsts, void ** srcs, size_t * sizes, size_t count, hipMemcpyAttributes * attrs, size_t * attrsIdxs, size_t numAttrs, size_t * failIdx, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipMemGetHandleForAddressRange_t)(void * handle, hipDeviceptr_t dptr, size_t size, hipMemRangeHandleType handleType, unsigned long long flags, void* return_address);
...
typedef hipError_t (*__hipLibraryGetKernelCount_t)(unsigned int * count, hipLibrary_t library, void* return_address);
...
typedef hipError_t (*__hipStreamGetAttribute_t)(hipStream_t stream, hipLaunchAttributeID attr, hipLaunchAttributeValue * value_out, void* return_address);
...
typedef hipError_t (*__hipLibraryGetKernel_t)(hipKernel_t * pKernel, hipLibrary_t library, const char * name, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D32Async_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned int value, size_t width, size_t height, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipModuleGetFunctionCount_t)(unsigned int * count, hipModule_t mod, void* return_address);
...
typedef hipError_t (*__hipGraphExecNodeSetParams_t)(hipGraphExec_t graphExec, hipGraphNode_t node, hipGraphNodeParams * nodeParams, void* return_address);
...
typedef hipError_t (*__hipGraphBatchMemOpNodeGetParams_t)(hipGraphNode_t hNode, hipBatchMemOpNodeParams * nodeParams_out, void* return_address);
...
typedef hipError_t (*__hipDrvGraphMemcpyNodeSetParams_t)(hipGraphNode_t hNode, const HIP_MEMCPY3D * nodeParams, void* return_address);
...
typedef hipError_t (*__hipLinkAddFile_t)(hipLinkState_t state, hipJitInputType type, const char * path, unsigned int numOptions, hipJitOption * options, void ** optionValues, void* return_address);
...
typedef hipError_t (*__hipDrvLaunchKernelEx_t)(const HIP_LAUNCH_CONFIG * config, hipFunction_t f, void ** params, void ** extra, void* return_address);
...
typedef hipError_t (*__hipMemcpy3DPeer_t)(hipMemcpy3DPeerParms * p, void* return_address);
...
typedef hipError_t (*__hipStreamBatchMemOp_t)(hipStream_t stream, unsigned int count, hipStreamBatchMemOpParams * paramArray, unsigned int flags, void* return_address);
...
typedef hipError_t (*__hipMemsetD2D32_t)(hipDeviceptr_t dst, size_t dstPitch, unsigned int value, size_t width, size_t height, void* return_address);

hipError_t i_hipDrvGraphMemcpyNodeGetParams(hipGraphNode_t hNode, HIP_MEMCPY3D * nodeParams, void* return_address);
typedef hipError_t (*__hipDrvGraphMemcpyNodeGetParams_t)(hipGraphNode_t hNode, HIP_MEMCPY3D * nodeParams, void* return_address);
...
typedef hipError_t (*__hipOccupancyAvailableDynamicSMemPerBlock_t)(size_t * dynamicSmemSize, const void * f, int numBlocks, int blockSize, void* return_address);
...
typedef hipError_t (*__hipDrvGraphAddMemsetNode_t)(hipGraphNode_t * phGraphNode, hipGraph_t hGraph, const hipGraphNode_t * dependencies, size_t numDependencies, const hipMemsetParams * memsetParams, hipCtx_t ctx, void* return_address);
...
typedef hipError_t (*__hipModuleLoadFatBinary_t)(hipModule_t * module, const void * fatbin, void* return_address);
...
typedef hipError_t (*__hipMemcpy3DPeerAsync_t)(hipMemcpy3DPeerParms * p, hipStream_t stream, void* return_address);
...
typedef hipError_t (*__hipKernelGetName_t)(const char ** name, hipKernel_t kernel, void* return_address);
...
typedef hipError_t (*__hipDrvGraphExecMemsetNodeSetParams_t)(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const hipMemsetParams * memsetParams, hipCtx_t ctx, void* return_address);
...
typedef hipError_t (*__hipMemAdvise_v2_t)(const void * dev_ptr, size_t count, hipMemoryAdvise advice, hipMemLocation location, void* return_address);
...
typedef hipError_t (*__hipChooseDevice_t)(int * device, const hipDeviceProp_t * prop, void* return_address);
...
typedef hipError_t (*__hipExtModuleLaunchKernel_t)(hipFunction_t f, uint32_t globalWorkSizeX, uint32_t globalWorkSizeY, uint32_t globalWorkSizeZ, uint32_t localWorkSizeX, uint32_t localWorkSizeY, uint32_t localWorkSizeZ, size_t sharedMemBytes, hipStream_t hStream, void ** kernelParams, void ** extra, hipEvent_t startEvent, hipEvent_t stopEvent, uint32_t flags, void* return_address);

hipError_t i_hipGetDeviceProperties(hipDeviceProp_t * prop, int deviceId, void* return_address);
typedef hipError_t (*__hipGetDeviceProperties_t)(hipDeviceProp_t * prop, int deviceId, void* return_address);

void* i___hipRegisterFatBinary(const void* data, void* return_address);
typedef void* (*____hipRegisterFatBinary_t)(const void* data, void* return_address);

void i___hipUnregisterFatBinary(void* module, void* return_address);
typedef void (*____hipUnregisterFatBinary_t)(void* module, void* return_address);
...
typedef void (*____hipRegisterFunction_t)(void** modules, const void* hostFunction, char* deviceFunction, const char* deviceName, unsigned int threadLimit, uint3* tid, uint3* bid, dim3* blockDim, dim3* gridDim, int* wSize, void* return_address);
...
typedef void (*____hipRegisterManagedVar_t)(void* hipModule, void** pointer, void* init_value, const char* name, size_t size, unsigned int align, void* return_address);
...
typedef void (*____hipRegisterVar_t)(void** modules, void* var, char* hostVar, char* deviceVar, int ext, size_t size, int constant, int global, void* return_address);

void i___hipRegisterSurface(void** modules, void* var, char* hostVar, char* deviceVar, int type, int ext, void* return_address);
typedef void (*____hipRegisterSurface_t)(void** modules, void* var, char* hostVar, char* deviceVar, int type, int ext, void* return_address);
...
typedef void (*____hipRegisterTexture_t)(void** modules, void* var, char* hostVar, char* deviceVar, int type, int norm, int ext, void* return_address);
