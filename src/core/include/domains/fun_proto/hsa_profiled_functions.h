...
typedef hsa_status_t (*__hsa_amd_ais_file_write_t)(hsa_amd_ais_file_handle_t handle, void * devicePtr, uint64_t size, int64_t file_offset, uint64_t * size_copied, int32_t * status, void* return_address);
...
typedef hsa_status_t (*__hsa_amd_memory_get_preferred_copy_engine_t)(hsa_agent_t dst_agent, hsa_agent_t src_agent, uint32_t * recommended_ids_mask, void* return_address);
...
typedef hsa_status_t (*__hsa_amd_portable_export_dmabuf_v2_t)(const void * ptr, size_t size, int * dmabuf, uint64_t * offset, uint64_t flags, void* return_address);
...
typedef hsa_status_t (*__hsa_ext_sampler_create_v2_t)(hsa_agent_t agent, const hsa_ext_sampler_descriptor_v2_t * sampler_descriptor, hsa_ext_sampler_t * sampler, void* return_address);
...
typedef hsa_status_t (*__hsa_amd_enable_logging_t)(uint8_t * flags, void * file, void* return_address);
...
typedef hsa_status_t (*__hsa_amd_interop_map_buffer_t)(uint32_t num_agents, hsa_agent_t * agents, hsa_handle_t interop_handle, uint32_t flags, size_t * size, void ** ptr, size_t * metadata_size, const void ** metadata, void* return_address);
...
typedef hsa_status_t (*__hsa_amd_ais_file_read_t)(hsa_amd_ais_file_handle_t handle, void * devicePtr, uint64_t size, int64_t file_offset, uint64_t * size_copied, int32_t * status, void* return_address);
...
typedef uint32_t (*__hsa_amd_signal_wait_all_t)(uint32_t signal_count, hsa_signal_t * signals, hsa_signal_condition_t * conds, hsa_signal_value_t * values, uint64_t timeout_hint, hsa_wait_state_t wait_hint, hsa_signal_value_t * satisfying_values, void* return_address);
