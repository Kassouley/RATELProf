...
#define GET_ARGS_VALUE_hipWaitExternalSemaphoresAsync(activity) { \
	activity->hip_args.hipWaitExternalSemaphoresAsync.extSemArray = (const hipExternalSemaphore_t**)extSemArray; \
	activity->hip_args.hipWaitExternalSemaphoresAsync.paramsArray = (const hipExternalSemaphoreWaitParams*)paramsArray; \
...
#define GET_ARGS_VALUE_hipDrvPointerGetAttributes(activity) { \
	...
	activity->hip_args.hipDrvPointerGetAttributes.ptr = (hipDeviceptr_t*)ptr; \
};
...
#define GET_ARGS_VALUE_hipMemGetAddressRange(activity) { \
	activity->hip_args.hipMemGetAddressRange.pbase = (hipDeviceptr_t**)pbase; \
	activity->hip_args.hipMemGetAddressRange.psize = (size_t*)psize; \
	activity->hip_args.hipMemGetAddressRange.dptr = (hipDeviceptr_t*)dptr; \
};
...
#define GET_ARGS_VALUE_hipGraphExecExternalSemaphoresWaitNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExecExternalSemaphoresWaitNodeSetParams.nodeParams = (const hipExternalSemaphoreWaitNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemGetAllocationGranularity(activity) { \
	...
	activity->hip_args.hipMemGetAllocationGranularity.prop = (const hipMemAllocationProp*)prop; \
...
#define GET_ARGS_VALUE_hipMemcpyPeerAsync(activity) { \
	...
	activity->hip_args.hipMemcpyPeerAsync.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipTexRefGetFormat(activity) { \
	...
	activity->hip_args.hipTexRefGetFormat.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipLaunchKernel(activity) { \
	activity->hip_args.hipLaunchKernel.function_address = (const void*)function_address; \
...
#define GET_ARGS_VALUE_hipMemcpy2DToArray(activity) { \
	...
	activity->hip_args.hipMemcpy2DToArray.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyFromSymbolAsync(activity) { \
	...
	activity->hip_args.hipMemcpyFromSymbolAsync.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipGraphKernelNodeSetAttribute(activity) { \
	...
	activity->hip_args.hipGraphKernelNodeSetAttribute.value = (const hipLaunchAttributeValue*)value; \
};
...
#define GET_ARGS_VALUE_hipExtLaunchKernel(activity) { \
	activity->hip_args.hipExtLaunchKernel.function_address = (const void*)function_address; \
...
#define GET_ARGS_VALUE_hipGraphExecMemcpyNodeSetParamsToSymbol(activity) { \
	...
	activity->hip_args.hipGraphExecMemcpyNodeSetParamsToSymbol.symbol = (const void*)symbol; \
	activity->hip_args.hipGraphExecMemcpyNodeSetParamsToSymbol.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipGetSymbolSize(activity) { \
	...
	activity->hip_args.hipGetSymbolSize.symbol = (const void*)symbol; \
};
...
#define GET_ARGS_VALUE_hipDestroyExternalMemory(activity) { \
	activity->hip_args.hipDestroyExternalMemory.extMem = (hipExternalMemory_t*)extMem; \
};
...
#define GET_ARGS_VALUE_hipGetProcAddress(activity) { \
	activity->hip_args.hipGetProcAddress.symbol = (const char*)symbol; \
...
#define GET_ARGS_VALUE_hipMemGetAccess(activity) { \
	...
	activity->hip_args.hipMemGetAccess.location = (const hipMemLocation*)location; \
...
#define GET_ARGS_VALUE_hipImportExternalSemaphore(activity) { \
	activity->hip_args.hipImportExternalSemaphore.extSem_out = (hipExternalSemaphore_t**)extSem_out; \
	activity->hip_args.hipImportExternalSemaphore.semHandleDesc = (const hipExternalSemaphoreHandleDesc*)semHandleDesc; \
};
...
#define GET_ARGS_VALUE_hipBindTexture2D(activity) { \
	...
	activity->hip_args.hipBindTexture2D.tex = (const textureReference*)tex; \
	activity->hip_args.hipBindTexture2D.devPtr = (const void*)devPtr; \
	activity->hip_args.hipBindTexture2D.desc = (const hipChannelFormatDesc*)desc; \
...
#define GET_ARGS_VALUE_hipGraphRemoveDependencies(activity) { \
	...
	activity->hip_args.hipGraphRemoveDependencies.from = (const hipGraphNode_t*)from; \
	activity->hip_args.hipGraphRemoveDependencies.to = (const hipGraphNode_t*)to; \
...
#define GET_ARGS_VALUE_hipMemcpy(activity) { \
	...
	activity->hip_args.hipMemcpy.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipTexRefGetAddress(activity) { \
	activity->hip_args.hipTexRefGetAddress.dev_ptr = (hipDeviceptr_t**)dev_ptr; \
	activity->hip_args.hipTexRefGetAddress.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipMemcpyToArray(activity) { \
	...
	activity->hip_args.hipMemcpyToArray.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipGraphExecHostNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExecHostNodeSetParams.pNodeParams = (const hipHostNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemAllocPitch(activity) { \
	activity->hip_args.hipMemAllocPitch.dptr = (hipDeviceptr_t**)dptr; \
...
#define GET_ARGS_VALUE_hipLaunchCooperativeKernel_spt(activity) { \
	activity->hip_args.hipLaunchCooperativeKernel_spt.f = (const void*)f; \
...
#define GET_ARGS_VALUE_hipTexRefGetFlags(activity) { \
	...
	activity->hip_args.hipTexRefGetFlags.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipLaunchKernel_spt(activity) { \
	activity->hip_args.hipLaunchKernel_spt.function_address = (const void*)function_address; \
...
#define GET_ARGS_VALUE_hipGraphMemcpyNodeSetParams1D(activity) { \
	...
	activity->hip_args.hipGraphMemcpyNodeSetParams1D.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMallocMipmappedArray(activity) { \
	activity->hip_args.hipMallocMipmappedArray.mipmappedArray = (hipMipmappedArray_t*)mipmappedArray; \
	activity->hip_args.hipMallocMipmappedArray.desc = (const struct hipChannelFormatDesc*)desc; \
...
#define GET_ARGS_VALUE_hipDeviceGetByPCIBusId(activity) { \
	...
	activity->hip_args.hipDeviceGetByPCIBusId.pciBusId = (const char*)pciBusId; \
};
...
#define GET_ARGS_VALUE_hipStreamGetCaptureInfo_v2_spt(activity) { \
	...
	activity->hip_args.hipStreamGetCaptureInfo_v2_spt.dependencies_out = (const hipGraphNode_t**)dependencies_out; \
...
#define GET_ARGS_VALUE_hipTexRefSetAddress(activity) { \
	...
	activity->hip_args.hipTexRefSetAddress.dptr = (hipDeviceptr_t*)dptr; \
...
#define GET_ARGS_VALUE_hipArray3DCreate(activity) { \
	...
	activity->hip_args.hipArray3DCreate.pAllocateArray = (const HIP_ARRAY3D_DESCRIPTOR*)pAllocateArray; \
};
...
#define GET_ARGS_VALUE_hipFreeMipmappedArray(activity) { \
	activity->hip_args.hipFreeMipmappedArray.mipmappedArray = (hipMipmappedArray_t)mipmappedArray; \
};
...
#define GET_ARGS_VALUE_hipOccupancyMaxActiveBlocksPerMultiprocessor(activity) { \
	...
	activity->hip_args.hipOccupancyMaxActiveBlocksPerMultiprocessor.f = (const void*)f; \
...
#define GET_ARGS_VALUE_hipGraphExternalSemaphoresWaitNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExternalSemaphoresWaitNodeSetParams.nodeParams = (const hipExternalSemaphoreWaitNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemsetD32(activity) { \
	activity->hip_args.hipMemsetD32.dest = (hipDeviceptr_t*)dest; \
...
#define GET_ARGS_VALUE_hipModuleGetTexRef(activity) { \
	...
	activity->hip_args.hipModuleGetTexRef.name = (const char*)name; \
};
...
#define GET_ARGS_VALUE_hipLaunchCooperativeKernel(activity) { \
	activity->hip_args.hipLaunchCooperativeKernel.f = (const void*)f; \
...
#define GET_ARGS_VALUE_hipKernelNameRef(activity) { \
	activity->hip_args.hipKernelNameRef.f = (const hipFunction_t)f; \
};
...
#define GET_ARGS_VALUE_hipGraphAddKernelNode(activity) { \
	...
	activity->hip_args.hipGraphAddKernelNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddKernelNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddKernelNode.pNodeParams = (const hipKernelNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipFuncSetAttribute(activity) { \
	activity->hip_args.hipFuncSetAttribute.func = (const void*)func; \
...
#define GET_ARGS_VALUE_hipMemcpyHtoAAsync(activity) { \
	...
	activity->hip_args.hipMemcpyHtoAAsync.srcHost = (const void*)srcHost; \
...
#define GET_ARGS_VALUE_hipMipmappedArrayCreate(activity) { \
	activity->hip_args.hipMipmappedArrayCreate.pHandle = (hipMipmappedArray_t*)pHandle; \
...
#define GET_ARGS_VALUE_hipGraphExecMemsetNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExecMemsetNodeSetParams.pNodeParams = (const hipMemsetParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipTexRefGetMipmapLevelBias(activity) { \
	...
	activity->hip_args.hipTexRefGetMipmapLevelBias.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipTexRefGetMipmapLevelClamp(activity) { \
	...
	activity->hip_args.hipTexRefGetMipmapLevelClamp.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipMemcpy3DAsync(activity) { \
	activity->hip_args.hipMemcpy3DAsync.p = (const struct hipMemcpy3DParms*)p; \
...
#define GET_ARGS_VALUE_hipMemcpyPeer(activity) { \
	...
	activity->hip_args.hipMemcpyPeer.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipGetTextureReference(activity) { \
	activity->hip_args.hipGetTextureReference.texref = (const textureReference**)texref; \
	activity->hip_args.hipGetTextureReference.symbol = (const void*)symbol; \
};
...
#define GET_ARGS_VALUE_hipDrvGetErrorName(activity) { \
	...
	activity->hip_args.hipDrvGetErrorName.errorString = (const char**)errorString; \
};
...
#define GET_ARGS_VALUE_hipMipmappedArrayGetLevel(activity) { \
	...
	activity->hip_args.hipMipmappedArrayGetLevel.hMipMappedArray = (hipMipmappedArray_t)hMipMappedArray; \
...
#define GET_ARGS_VALUE_hipMallocArray(activity) { \
	...
	activity->hip_args.hipMallocArray.desc = (const hipChannelFormatDesc*)desc; \
...
#define GET_ARGS_VALUE_hipMemcpyDtoD(activity) { \
	activity->hip_args.hipMemcpyDtoD.dst = (hipDeviceptr_t*)dst; \
	activity->hip_args.hipMemcpyDtoD.src = (hipDeviceptr_t*)src; \
...
#define GET_ARGS_VALUE_hipGraphAddMemcpyNodeFromSymbol(activity) { \
	...
	activity->hip_args.hipGraphAddMemcpyNodeFromSymbol.pDependencies = (const hipGraphNode_t*)pDependencies; \
	...
	activity->hip_args.hipGraphAddMemcpyNodeFromSymbol.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipOccupancyMaxPotentialBlockSize(activity) { \
	...
	activity->hip_args.hipOccupancyMaxPotentialBlockSize.f = (const void*)f; \
...
#define GET_ARGS_VALUE_hipMemsetD8(activity) { \
	activity->hip_args.hipMemsetD8.dest = (hipDeviceptr_t*)dest; \
...
#define GET_ARGS_VALUE_hipGraphAddMemAllocNode(activity) { \
	...
	activity->hip_args.hipGraphAddMemAllocNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipMemcpyParam2D(activity) { \
	activity->hip_args.hipMemcpyParam2D.pCopy = (const hip_Memcpy2D*)pCopy; \
};
...
#define GET_ARGS_VALUE_hipBindTextureToMipmappedArray(activity) { \
	activity->hip_args.hipBindTextureToMipmappedArray.tex = (const textureReference*)tex; \
	activity->hip_args.hipBindTextureToMipmappedArray.mipmappedArray = (hipMipmappedArray_const_t)mipmappedArray; \
	activity->hip_args.hipBindTextureToMipmappedArray.desc = (const hipChannelFormatDesc*)desc; \
};
...
#define GET_ARGS_VALUE_hipGraphAddEmptyNode(activity) { \
	...
	activity->hip_args.hipGraphAddEmptyNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipMemPoolSetAccess(activity) { \
	...
	activity->hip_args.hipMemPoolSetAccess.desc_list = (const hipMemAccessDesc*)desc_list; \
...
#define GET_ARGS_VALUE_hipGraphAddEventWaitNode(activity) { \
	...
	activity->hip_args.hipGraphAddEventWaitNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipUnbindTexture(activity) { \
	activity->hip_args.hipUnbindTexture.tex = (const textureReference*)tex; \
};
...
#define GET_ARGS_VALUE_hipPointerGetAttributes(activity) { \
	...
	activity->hip_args.hipPointerGetAttributes.ptr = (const void*)ptr; \
};
...
#define GET_ARGS_VALUE_hipGraphAddNode(activity) { \
	...
	activity->hip_args.hipGraphAddNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipModuleGetGlobal(activity) { \
	activity->hip_args.hipModuleGetGlobal.dptr = (hipDeviceptr_t**)dptr; \
	activity->hip_args.hipModuleGetGlobal.bytes = (size_t*)bytes; \
	activity->hip_args.hipModuleGetGlobal.hmod = (hipModule_t)hmod; \
	activity->hip_args.hipModuleGetGlobal.name = (const char*)name; \
};
...
#define GET_ARGS_VALUE_hipExtStreamCreateWithCUMask(activity) { \
	...
	activity->hip_args.hipExtStreamCreateWithCUMask.cuMask = (const uint32_t*)cuMask; \
};
...
#define GET_ARGS_VALUE_hipBindTexture(activity) { \
	...
	activity->hip_args.hipBindTexture.tex = (const textureReference*)tex; \
	activity->hip_args.hipBindTexture.devPtr = (const void*)devPtr; \
	activity->hip_args.hipBindTexture.desc = (const hipChannelFormatDesc*)desc; \
...
#define GET_ARGS_VALUE_hipSetupArgument(activity) { \
	activity->hip_args.hipSetupArgument.arg = (const void*)arg; \
...
#define GET_ARGS_VALUE_hipFuncSetCacheConfig(activity) { \
	activity->hip_args.hipFuncSetCacheConfig.func = (const void*)func; \
...
#define GET_ARGS_VALUE_hipDrvGetErrorString(activity) { \
	...
	activity->hip_args.hipDrvGetErrorString.errorString = (const char**)errorString; \
};
...
#define GET_ARGS_VALUE_hipMemsetD16Async(activity) { \
	activity->hip_args.hipMemsetD16Async.dest = (hipDeviceptr_t*)dest; \
...
#define GET_ARGS_VALUE_hipGraphAddMemsetNode(activity) { \
	...
	activity->hip_args.hipGraphAddMemsetNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddMemsetNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddMemsetNode.pMemsetParams = (const hipMemsetParams*)pMemsetParams; \
};
...
#define GET_ARGS_VALUE_hipChooseDeviceR0600(activity) { \
	...
	activity->hip_args.hipChooseDeviceR0600.prop = (const hipDeviceProp_tR0600*)prop; \
};
...
#define GET_ARGS_VALUE_hipMemRangeGetAttribute(activity) { \
	...
	activity->hip_args.hipMemRangeGetAttribute.dev_ptr = (const void*)dev_ptr; \
...
#define GET_ARGS_VALUE_hipCreateSurfaceObject(activity) { \
	...
	activity->hip_args.hipCreateSurfaceObject.pResDesc = (const hipResourceDesc*)pResDesc; \
};
...
#define GET_ARGS_VALUE_hipArrayCreate(activity) { \
	...
	activity->hip_args.hipArrayCreate.pAllocateArray = (const HIP_ARRAY_DESCRIPTOR*)pAllocateArray; \
};
...
#define GET_ARGS_VALUE_hipMemcpyAsync_spt(activity) { \
	...
	activity->hip_args.hipMemcpyAsync_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipTexRefGetMipmapFilterMode(activity) { \
	...
	activity->hip_args.hipTexRefGetMipmapFilterMode.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipMemsetD32Async(activity) { \
	activity->hip_args.hipMemsetD32Async.dst = (hipDeviceptr_t*)dst; \
...
#define GET_ARGS_VALUE_hipGraphAddDependencies(activity) { \
	...
	activity->hip_args.hipGraphAddDependencies.from = (const hipGraphNode_t*)from; \
	activity->hip_args.hipGraphAddDependencies.to = (const hipGraphNode_t*)to; \
...
#define GET_ARGS_VALUE_hipGraphMemcpyNodeSetParamsToSymbol(activity) { \
	...
	activity->hip_args.hipGraphMemcpyNodeSetParamsToSymbol.symbol = (const void*)symbol; \
	activity->hip_args.hipGraphMemcpyNodeSetParamsToSymbol.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipPointerGetAttribute(activity) { \
	...
	activity->hip_args.hipPointerGetAttribute.ptr = (hipDeviceptr_t*)ptr; \
};
...
#define GET_ARGS_VALUE_hipMemPrefetchAsync(activity) { \
	activity->hip_args.hipMemPrefetchAsync.dev_ptr = (const void*)dev_ptr; \
...
#define GET_ARGS_VALUE_hipMemcpyDtoA(activity) { \
	...
	activity->hip_args.hipMemcpyDtoA.srcDevice = (hipDeviceptr_t*)srcDevice; \
...
#define GET_ARGS_VALUE_hipMemcpy_spt(activity) { \
	...
	activity->hip_args.hipMemcpy_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipPointerSetAttribute(activity) { \
	activity->hip_args.hipPointerSetAttribute.value = (const void*)value; \
	activity->hip_args.hipPointerSetAttribute.attribute = (hipPointer_attribute)attribute; \
	activity->hip_args.hipPointerSetAttribute.ptr = (hipDeviceptr_t*)ptr; \
};
...
#define GET_ARGS_VALUE_hipLaunchByPtr(activity) { \
	activity->hip_args.hipLaunchByPtr.func = (const void*)func; \
};
...
#define GET_ARGS_VALUE_hipMemcpy2DAsync_spt(activity) { \
	...
	activity->hip_args.hipMemcpy2DAsync_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemsetD16(activity) { \
	activity->hip_args.hipMemsetD16.dest = (hipDeviceptr_t*)dest; \
...
#define GET_ARGS_VALUE_hipMemcpyFromSymbol_spt(activity) { \
	...
	activity->hip_args.hipMemcpyFromSymbol_spt.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipMemcpyToSymbolAsync_spt(activity) { \
	activity->hip_args.hipMemcpyToSymbolAsync_spt.symbol = (const void*)symbol; \
	activity->hip_args.hipMemcpyToSymbolAsync_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipModuleGetFunction(activity) { \
	...
	activity->hip_args.hipModuleGetFunction.kname = (const char*)kname; \
};
...
#define GET_ARGS_VALUE_hipGetMipmappedArrayLevel(activity) { \
	...
	activity->hip_args.hipGetMipmappedArrayLevel.mipmappedArray = (hipMipmappedArray_const_t)mipmappedArray; \
...
#define GET_ARGS_VALUE_hipGraphAddChildGraphNode(activity) { \
	...
	activity->hip_args.hipGraphAddChildGraphNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipMemcpyToSymbolAsync(activity) { \
	activity->hip_args.hipMemcpyToSymbolAsync.symbol = (const void*)symbol; \
	activity->hip_args.hipMemcpyToSymbolAsync.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpy3DAsync_spt(activity) { \
	activity->hip_args.hipMemcpy3DAsync_spt.p = (const hipMemcpy3DParms*)p; \
...
#define GET_ARGS_VALUE_hipGraphDebugDotPrint(activity) { \
	...
	activity->hip_args.hipGraphDebugDotPrint.path = (const char*)path; \
...
#define GET_ARGS_VALUE_hipGetTextureAlignmentOffset(activity) { \
	...
	activity->hip_args.hipGetTextureAlignmentOffset.texref = (const textureReference*)texref; \
};
...
#define GET_ARGS_VALUE_hipMemcpy2D_spt(activity) { \
	...
	activity->hip_args.hipMemcpy2D_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipDrvMemcpy2DUnaligned(activity) { \
	activity->hip_args.hipDrvMemcpy2DUnaligned.pCopy = (const hip_Memcpy2D*)pCopy; \
};
...
#define GET_ARGS_VALUE_hipGraphExternalSemaphoresSignalNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExternalSemaphoresSignalNodeSetParams.nodeParams = (const hipExternalSemaphoreSignalNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemPoolCreate(activity) { \
	...
	activity->hip_args.hipMemPoolCreate.pool_props = (const hipMemPoolProps*)pool_props; \
};
...
#define GET_ARGS_VALUE_hipTexRefGetBorderColor(activity) { \
	...
	activity->hip_args.hipTexRefGetBorderColor.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipGraphExecMemcpyNodeSetParams1D(activity) { \
	...
	activity->hip_args.hipGraphExecMemcpyNodeSetParams1D.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyToSymbol(activity) { \
	activity->hip_args.hipMemcpyToSymbol.symbol = (const void*)symbol; \
	activity->hip_args.hipMemcpyToSymbol.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(activity) { \
	...
	activity->hip_args.hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.f = (const void*)f; \
...
#define GET_ARGS_VALUE_hipMemcpy3D(activity) { \
	activity->hip_args.hipMemcpy3D.p = (const struct hipMemcpy3DParms*)p; \
};
...
#define GET_ARGS_VALUE_hipGraphAddMemcpyNodeToSymbol(activity) { \
	...
	activity->hip_args.hipGraphAddMemcpyNodeToSymbol.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddMemcpyNodeToSymbol.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddMemcpyNodeToSymbol.symbol = (const void*)symbol; \
	activity->hip_args.hipGraphAddMemcpyNodeToSymbol.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyDtoDAsync(activity) { \
	activity->hip_args.hipMemcpyDtoDAsync.dst = (hipDeviceptr_t*)dst; \
	activity->hip_args.hipMemcpyDtoDAsync.src = (hipDeviceptr_t*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyDtoHAsync(activity) { \
	...
	activity->hip_args.hipMemcpyDtoHAsync.src = (hipDeviceptr_t*)src; \
...
#define GET_ARGS_VALUE_hipMemcpy2DAsync(activity) { \
	...
	activity->hip_args.hipMemcpy2DAsync.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyHtoA(activity) { \
	...
	activity->hip_args.hipMemcpyHtoA.srcHost = (const void*)srcHost; \
...
#define GET_ARGS_VALUE_hipDrvGraphAddMemcpyNode(activity) { \
	...
	activity->hip_args.hipDrvGraphAddMemcpyNode.dependencies = (const hipGraphNode_t*)dependencies; \
	activity->hip_args.hipDrvGraphAddMemcpyNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipDrvGraphAddMemcpyNode.copyParams = (const HIP_MEMCPY3D*)copyParams; \
...
#define GET_ARGS_VALUE_hipMemcpy2D(activity) { \
	...
	activity->hip_args.hipMemcpy2D.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMipmappedArrayDestroy(activity) { \
	activity->hip_args.hipMipmappedArrayDestroy.hMipmappedArray = (hipMipmappedArray_t)hMipmappedArray; \
};
...
#define GET_ARGS_VALUE_hipDrvMemcpy3DAsync(activity) { \
	activity->hip_args.hipDrvMemcpy3DAsync.pCopy = (const HIP_MEMCPY3D*)pCopy; \
...
#define GET_ARGS_VALUE_hipTexRefSetAddress2D(activity) { \
	...
	activity->hip_args.hipTexRefSetAddress2D.desc = (const HIP_ARRAY_DESCRIPTOR*)desc; \
	activity->hip_args.hipTexRefSetAddress2D.dptr = (hipDeviceptr_t*)dptr; \
...
#define GET_ARGS_VALUE_hipExternalMemoryGetMappedBuffer(activity) { \
	...
	activity->hip_args.hipExternalMemoryGetMappedBuffer.extMem = (hipExternalMemory_t*)extMem; \
	activity->hip_args.hipExternalMemoryGetMappedBuffer.bufferDesc = (const hipExternalMemoryBufferDesc*)bufferDesc; \
};
...
#define GET_ARGS_VALUE_hipTexObjectCreate(activity) { \
	...
	activity->hip_args.hipTexObjectCreate.pResDesc = (const HIP_RESOURCE_DESC*)pResDesc; \
	activity->hip_args.hipTexObjectCreate.pTexDesc = (const HIP_TEXTURE_DESC*)pTexDesc; \
	activity->hip_args.hipTexObjectCreate.pResViewDesc = (const HIP_RESOURCE_VIEW_DESC*)pResViewDesc; \
};
...
#define GET_ARGS_VALUE_hipMemcpyAtoD(activity) { \
	activity->hip_args.hipMemcpyAtoD.dstDevice = (hipDeviceptr_t*)dstDevice; \
...
#define GET_ARGS_VALUE_hipDrvMemcpy3D(activity) { \
	activity->hip_args.hipDrvMemcpy3D.pCopy = (const HIP_MEMCPY3D*)pCopy; \
};
...
#define GET_ARGS_VALUE_hipMemcpyHtoD(activity) { \
	activity->hip_args.hipMemcpyHtoD.dst = (hipDeviceptr_t*)dst; \
...
#define GET_ARGS_VALUE_hipGraphKernelNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphKernelNodeSetParams.pNodeParams = (const hipKernelNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipGraphHostNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphHostNodeSetParams.pNodeParams = (const hipHostNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemcpyParam2DAsync(activity) { \
	activity->hip_args.hipMemcpyParam2DAsync.pCopy = (const hip_Memcpy2D*)pCopy; \
...
#define GET_ARGS_VALUE_hipExternalMemoryGetMappedMipmappedArray(activity) { \
	activity->hip_args.hipExternalMemoryGetMappedMipmappedArray.mipmap = (hipMipmappedArray_t*)mipmap; \
	activity->hip_args.hipExternalMemoryGetMappedMipmappedArray.extMem = (hipExternalMemory_t*)extMem; \
	activity->hip_args.hipExternalMemoryGetMappedMipmappedArray.mipmapDesc = (const hipExternalMemoryMipmappedArrayDesc*)mipmapDesc; \
};
...
#define GET_ARGS_VALUE_hipTexRefGetArray(activity) { \
	...
	activity->hip_args.hipTexRefGetArray.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipGraphAddExternalSemaphoresSignalNode(activity) { \
	...
	activity->hip_args.hipGraphAddExternalSemaphoresSignalNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddExternalSemaphoresSignalNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddExternalSemaphoresSignalNode.nodeParams = (const hipExternalSemaphoreSignalNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemcpyWithStream(activity) { \
	...
	activity->hip_args.hipMemcpyWithStream.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipBindTextureToArray(activity) { \
	activity->hip_args.hipBindTextureToArray.tex = (const textureReference*)tex; \
	activity->hip_args.hipBindTextureToArray.array = (hipArray_const_t)array; \
	activity->hip_args.hipBindTextureToArray.desc = (const hipChannelFormatDesc*)desc; \
};
...
#define GET_ARGS_VALUE_hipStreamBeginCaptureToGraph(activity) { \
	...
	activity->hip_args.hipStreamBeginCaptureToGraph.dependencies = (const hipGraphNode_t*)dependencies; \
	activity->hip_args.hipStreamBeginCaptureToGraph.dependencyData = (const hipGraphEdgeData*)dependencyData; \
...
#define GET_ARGS_VALUE_hipGraphMemcpyNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphMemcpyNodeSetParams.pNodeParams = (const hipMemcpy3DParms*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemcpyHtoDAsync(activity) { \
	activity->hip_args.hipMemcpyHtoDAsync.dst = (hipDeviceptr_t*)dst; \
...
#define GET_ARGS_VALUE_hipGraphAddExternalSemaphoresWaitNode(activity) { \
	...
	activity->hip_args.hipGraphAddExternalSemaphoresWaitNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddExternalSemaphoresWaitNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddExternalSemaphoresWaitNode.nodeParams = (const hipExternalSemaphoreWaitNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE___hipGetPCH(activity) { \
	activity->hip_args.__hipGetPCH.pch = (const char**)pch; \
...
#define GET_ARGS_VALUE_hipTexRefGetFilterMode(activity) { \
	...
	activity->hip_args.hipTexRefGetFilterMode.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipMalloc3DArray(activity) { \
	...
	activity->hip_args.hipMalloc3DArray.desc = (const struct hipChannelFormatDesc*)desc; \
...
#define GET_ARGS_VALUE_hipTexRefGetAddressMode(activity) { \
	...
	activity->hip_args.hipTexRefGetAddressMode.texRef = (const textureReference*)texRef; \
...
#define GET_ARGS_VALUE_hipModuleLoadData(activity) { \
	...
	activity->hip_args.hipModuleLoadData.image = (const void*)image; \
};
...
#define GET_ARGS_VALUE_hipGraphExecExternalSemaphoresSignalNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExecExternalSemaphoresSignalNodeSetParams.nodeParams = (const hipExternalSemaphoreSignalNodeParams*)nodeParams; \
};
...
#define GET_ARGS_VALUE_hipMemsetD8Async(activity) { \
	activity->hip_args.hipMemsetD8Async.dest = (hipDeviceptr_t*)dest; \
...
#define GET_ARGS_VALUE_hipDrvGraphAddMemsetNode(activity) { \
	...
	activity->hip_args.hipDrvGraphAddMemsetNode.dependencies = (const hipGraphNode_t*)dependencies; \
	activity->hip_args.hipDrvGraphAddMemsetNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipDrvGraphAddMemsetNode.memsetParams = (const HIP_MEMSET_NODE_PARAMS*)memsetParams; \
...
#define GET_ARGS_VALUE_hipGraphMemcpyNodeSetParamsFromSymbol(activity) { \
	...
	activity->hip_args.hipGraphMemcpyNodeSetParamsFromSymbol.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipMemcpy2DToArray_spt(activity) { \
	...
	activity->hip_args.hipMemcpy2DToArray_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipTexRefGetMipMappedArray(activity) { \
	activity->hip_args.hipTexRefGetMipMappedArray.pArray = (hipMipmappedArray_t*)pArray; \
	activity->hip_args.hipTexRefGetMipMappedArray.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipMemRangeGetAttributes(activity) { \
	...
	activity->hip_args.hipMemRangeGetAttributes.dev_ptr = (const void*)dev_ptr; \
...
#define GET_ARGS_VALUE_hipMemAdvise(activity) { \
	activity->hip_args.hipMemAdvise.dev_ptr = (const void*)dev_ptr; \
...
#define GET_ARGS_VALUE_hipGraphAddHostNode(activity) { \
	...
	activity->hip_args.hipGraphAddHostNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddHostNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddHostNode.pNodeParams = (const hipHostNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipFuncGetAttributes(activity) { \
	...
	activity->hip_args.hipFuncGetAttributes.func = (const void*)func; \
};
...
#define GET_ARGS_VALUE_hipTexRefGetMaxAnisotropy(activity) { \
	...
	activity->hip_args.hipTexRefGetMaxAnisotropy.texRef = (const textureReference*)texRef; \
};
...
#define GET_ARGS_VALUE_hipGraphAddMemFreeNode(activity) { \
	...
	activity->hip_args.hipGraphAddMemFreeNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipMemcpy3D_spt(activity) { \
	activity->hip_args.hipMemcpy3D_spt.p = (const struct hipMemcpy3DParms*)p; \
};
...
#define GET_ARGS_VALUE_hipMemcpy2DToArrayAsync(activity) { \
	...
	activity->hip_args.hipMemcpy2DToArrayAsync.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyDtoH(activity) { \
	...
	activity->hip_args.hipMemcpyDtoH.src = (hipDeviceptr_t*)src; \
...
#define GET_ARGS_VALUE_hipMemcpyAsync(activity) { \
	...
	activity->hip_args.hipMemcpyAsync.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemCreate(activity) { \
	...
	activity->hip_args.hipMemCreate.prop = (const hipMemAllocationProp*)prop; \
...
#define GET_ARGS_VALUE_hipFuncSetSharedMemConfig(activity) { \
	activity->hip_args.hipFuncSetSharedMemConfig.func = (const void*)func; \
...
#define GET_ARGS_VALUE_hipMemcpy2DToArrayAsync_spt(activity) { \
	...
	activity->hip_args.hipMemcpy2DToArrayAsync_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipMemSetAccess(activity) { \
	...
	activity->hip_args.hipMemSetAccess.desc = (const hipMemAccessDesc*)desc; \
...
#define GET_ARGS_VALUE_hipMemcpyFromSymbolAsync_spt(activity) { \
	...
	activity->hip_args.hipMemcpyFromSymbolAsync_spt.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipGetSymbolAddress(activity) { \
	...
	activity->hip_args.hipGetSymbolAddress.symbol = (const void*)symbol; \
};
...
#define GET_ARGS_VALUE_hipMemcpyToSymbol_spt(activity) { \
	activity->hip_args.hipMemcpyToSymbol_spt.symbol = (const void*)symbol; \
	activity->hip_args.hipMemcpyToSymbol_spt.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipGraphAddMemcpyNode1D(activity) { \
	...
	activity->hip_args.hipGraphAddMemcpyNode1D.pDependencies = (const hipGraphNode_t*)pDependencies; \
	...
	activity->hip_args.hipGraphAddMemcpyNode1D.src = (const void*)src; \
...
#define GET_ARGS_VALUE_hipDestroyExternalSemaphore(activity) { \
	activity->hip_args.hipDestroyExternalSemaphore.extSem = (hipExternalSemaphore_t*)extSem; \
};
...
#define GET_ARGS_VALUE_hipStreamGetCaptureInfo_v2(activity) { \
	...
	activity->hip_args.hipStreamGetCaptureInfo_v2.dependencies_out = (const hipGraphNode_t**)dependencies_out; \
...
#define GET_ARGS_VALUE_hipImportExternalMemory(activity) { \
	activity->hip_args.hipImportExternalMemory.extMem_out = (hipExternalMemory_t**)extMem_out; \
	activity->hip_args.hipImportExternalMemory.memHandleDesc = (const hipExternalMemoryHandleDesc*)memHandleDesc; \
};
...
#define GET_ARGS_VALUE_hipGraphExecKernelNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphExecKernelNodeSetParams.pNodeParams = (const hipKernelNodeParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipGraphExecMemcpyNodeSetParamsFromSymbol(activity) { \
	...
	activity->hip_args.hipGraphExecMemcpyNodeSetParamsFromSymbol.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipCreateTextureObject(activity) { \
	...
	activity->hip_args.hipCreateTextureObject.pResDesc = (const hipResourceDesc*)pResDesc; \
	activity->hip_args.hipCreateTextureObject.pTexDesc = (const hipTextureDesc*)pTexDesc; \
	activity->hip_args.hipCreateTextureObject.pResViewDesc = (const struct hipResourceViewDesc*)pResViewDesc; \
};
...
#define GET_ARGS_VALUE_hipModuleLoadDataEx(activity) { \
	...
	activity->hip_args.hipModuleLoadDataEx.image = (const void*)image; \
...
#define GET_ARGS_VALUE_hipMemcpyFromSymbol(activity) { \
	...
	activity->hip_args.hipMemcpyFromSymbol.symbol = (const void*)symbol; \
...
#define GET_ARGS_VALUE_hipGraphAddMemcpyNode(activity) { \
	...
	activity->hip_args.hipGraphAddMemcpyNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
	activity->hip_args.hipGraphAddMemcpyNode.numDependencies = (size_t)numDependencies; \
	activity->hip_args.hipGraphAddMemcpyNode.pCopyParams = (const hipMemcpy3DParms*)pCopyParams; \
};
...
#define GET_ARGS_VALUE_hipKernelNameRefByPtr(activity) { \
	activity->hip_args.hipKernelNameRefByPtr.hostFunction = (const void*)hostFunction; \
...
#define GET_ARGS_VALUE_hipGetFuncBySymbol(activity) { \
	...
	activity->hip_args.hipGetFuncBySymbol.symbolPtr = (const void*)symbolPtr; \
};
...
#define GET_ARGS_VALUE_hipGraphAddEventRecordNode(activity) { \
	...
	activity->hip_args.hipGraphAddEventRecordNode.pDependencies = (const hipGraphNode_t*)pDependencies; \
...
#define GET_ARGS_VALUE_hipGraphMemsetNodeSetParams(activity) { \
	...
	activity->hip_args.hipGraphMemsetNodeSetParams.pNodeParams = (const hipMemsetParams*)pNodeParams; \
};
...
#define GET_ARGS_VALUE_hipSignalExternalSemaphoresAsync(activity) { \
	activity->hip_args.hipSignalExternalSemaphoresAsync.extSemArray = (const hipExternalSemaphore_t**)extSemArray; \
	activity->hip_args.hipSignalExternalSemaphoresAsync.paramsArray = (const hipExternalSemaphoreSignalParams*)paramsArray; \
...
#define GET_ARGS_VALUE_hipModuleLoad(activity) { \
	...
	activity->hip_args.hipModuleLoad.fname = (const char*)fname; \
};
