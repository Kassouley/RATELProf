...
macro(hipGraphBatchMemOpNodeSetParams)             \
macro(hipGraphAddMemcpyNodeToSymbol)               \
macro(hipGetDriverEntryPoint)                      \
...
macro(hipDeviceGetTexture1DLinearMaxWidth)         \
...
macro(hipLinkComplete)                             \
macro(hipStreamEndCapture_spt)                     \
macro(hipMemsetD2D16Async)                         \
...
macro(hipDrvGraphExecMemcpyNodeSetParams)          \
...
macro(hipGraphAddBatchMemOpNode)                   \
...
macro(hipMemPrefetchAsync_v2)                      \
macro(hipLinkDestroy)                              \
...
macro(hipLibraryEnumerateKernels)                  \
macro(hipDeviceSynchronize)                        \
macro(hipLinkAddData)                              \
...
macro(hipDrvGraphAddMemFreeNode)                   \
...
macro(hipGetDriverEntryPoint_spt)                  \
...
macro(hipGraphExecBatchMemOpNodeSetParams)         \
...
macro(hipLinkAddFile)                              \
macro(hipConfigureCall)                            \
macro(hipDrvLaunchKernelEx)                        \
macro(hipMemGetInfo)                               \
macro(hipMemcpy3DPeer)                             \
...
macro(hipMemsetD2D32)                              \
macro(hipDrvGraphMemcpyNodeGetParams)              \
...
macro(hipOccupancyAvailableDynamicSMemPerBlock)    \
...
macro(hipModuleLoadFatBinary)                      \
macro(hipMemcpy2DAsync)                            \
macro(hipMemcpy3DPeerAsync)                        \
...
macro(hipDrvGraphExecMemsetNodeSetParams)          \
macro(hipGraphLaunch)                              \
macro(hipMemAdvise_v2)                             \
macro(hipMemcpyAtoH)                               \
macro(hipDevicePrimaryCtxGetState)                 \
macro(hipMemImportFromShareableHandle)             \
macro(hipChooseDevice)                             \
macro(hipExtModuleLaunchKernel)                    \
macro(hipGetDeviceProperties)                      \
macro(__hipRegisterFatBinary)                      \
macro(__hipUnregisterFatBinary)                    \
macro(__hipRegisterFunction)                       \
macro(__hipRegisterManagedVar)                     \
macro(__hipRegisterVar)                            \
macro(__hipRegisterSurface)                        \
macro(__hipRegisterTexture)                        \
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryUnload` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryUnload` function call.
 *
 * @struct args_hipLibraryUnload_t
 *
 * @note 
 *	hipError_t
 *	hipLibraryUnload (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLibraryUnload_t;

#define GET_ARGS_VALUE_hipLibraryUnload(activity) { \
	args_hipLibraryUnload_t* args = (args_hipLibraryUnload_t*) activity->args; \
	args->library = (hipLibrary_t) library; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipStreamSetAttribute` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipStreamSetAttribute` function call.
 *
 * @struct args_hipStreamSetAttribute_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipStreamSetAttribute_t;

#define GET_ARGS_VALUE_hipStreamSetAttribute(activity) { \
	args_hipStreamSetAttribute_t* args = (args_hipStreamSetAttribute_t*) activity->args; \
	args->stream = (hipStream_t) stream; \
	args->attr = (hipLaunchAttributeID) attr; \
	args->value = (hipLaunchAttributeValue *) value; \
};

#define GET_PTRS_VALUE_hipStreamSetAttribute(args) { \
	args_hipStreamSetAttribute_t* pargs = (args_hipStreamSetAttribute_t*) args; \
	if (pargs->value != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipStreamGetId` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipStreamGetId` function call.
 *
 * @struct args_hipStreamGetId_t
 *
 * @note 
 *	hipError_t
 *	hipStreamGetId (
...
typedef struct {
	...
	hipError_t retval;
} args_hipStreamGetId_t;

#define GET_ARGS_VALUE_hipStreamGetId(activity) { \
	args_hipStreamGetId_t* args = (args_hipStreamGetId_t*) activity->args; \
	args->stream = (hipStream_t) stream; \
	args->streamId = (unsigned long long *) streamId; \
};

#define GET_PTRS_VALUE_hipStreamGetId(args) { \
	args_hipStreamGetId_t* pargs = (args_hipStreamGetId_t*) args; \
	if (pargs->streamId != NULL) { \
		pargs->streamId__ref.val = *pargs->streamId; \
	} \
};
...
#define GET_PTRS_VALUE_hipModuleLoad(args) { \
	...
	if (pargs->fname != NULL) { \
		pargs->fname__ref.val = *pargs->fname; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipKernelGetLibrary` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipKernelGetLibrary` function call.
 *
 * @struct args_hipKernelGetLibrary_t
 *
 * @note 
 *	hipError_t
 *	hipKernelGetLibrary (
...
typedef struct {
	...
	hipKernel_t kernel;
	hipError_t retval;
} args_hipKernelGetLibrary_t;

#define GET_ARGS_VALUE_hipKernelGetLibrary(activity) { \
	args_hipKernelGetLibrary_t* args = (args_hipKernelGetLibrary_t*) activity->args; \
	args->library = (hipLibrary_t *) library; \
	args->kernel = (hipKernel_t) kernel; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGraphBatchMemOpNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphBatchMemOpNodeSetParams` function call.
 *
 * @struct args_hipGraphBatchMemOpNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	struct {
		hipBatchMemOpNodeParams  val;
	} nodeParams__ref;
	hipError_t retval;
} args_hipGraphBatchMemOpNodeSetParams_t;

#define GET_ARGS_VALUE_hipGraphBatchMemOpNodeSetParams(activity) { \
	args_hipGraphBatchMemOpNodeSetParams_t* args = (args_hipGraphBatchMemOpNodeSetParams_t*) activity->args; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->nodeParams = (hipBatchMemOpNodeParams *) nodeParams; \
};

#define GET_PTRS_VALUE_hipGraphBatchMemOpNodeSetParams(args) { \
	args_hipGraphBatchMemOpNodeSetParams_t* pargs = (args_hipGraphBatchMemOpNodeSetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGetDriverEntryPoint` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGetDriverEntryPoint` function call.
 *
 * @struct args_hipGetDriverEntryPoint_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	struct {
		hipDriverEntryPointQueryResult  val;
	} driverStatus__ref;
	hipError_t retval;
} args_hipGetDriverEntryPoint_t;

#define GET_ARGS_VALUE_hipGetDriverEntryPoint(activity) { \
	args_hipGetDriverEntryPoint_t* args = (args_hipGetDriverEntryPoint_t*) activity->args; \
	args->symbol = (char *) symbol; \
	args->funcPtr = (void **) funcPtr; \
	args->flags = (unsigned long long) flags; \
	args->driverStatus = (hipDriverEntryPointQueryResult *) driverStatus; \
};

#define GET_PTRS_VALUE_hipGetDriverEntryPoint(args) { \
	args_hipGetDriverEntryPoint_t* pargs = (args_hipGetDriverEntryPoint_t*) args; \
	if (pargs->symbol != NULL) { \
		pargs->symbol__ref.val = *pargs->symbol; \
	} \
	if (pargs->funcPtr != NULL) { \
		pargs->funcPtr__ref.ptr1 = *pargs->funcPtr; \
	} \
	if (pargs->driverStatus != NULL) { \
		pargs->driverStatus__ref.val = *pargs->driverStatus; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGraphExecGetFlags` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphExecGetFlags` function call.
 *
 * @struct args_hipGraphExecGetFlags_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphExecGetFlags_t;

#define GET_ARGS_VALUE_hipGraphExecGetFlags(activity) { \
	args_hipGraphExecGetFlags_t* args = (args_hipGraphExecGetFlags_t*) activity->args; \
	args->graphExec = (hipGraphExec_t) graphExec; \
	args->flags = (unsigned long long *) flags; \
};

#define GET_PTRS_VALUE_hipGraphExecGetFlags(args) { \
	args_hipGraphExecGetFlags_t* pargs = (args_hipGraphExecGetFlags_t*) args; \
	if (pargs->flags != NULL) { \
		pargs->flags__ref.val = *pargs->flags; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLaunchKernelExC` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLaunchKernelExC` function call.
 *
 * @struct args_hipLaunchKernelExC_t
 *
 * @note 
 *	hipError_t
 *	hipLaunchKernelExC (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLaunchKernelExC_t;

#define GET_ARGS_VALUE_hipLaunchKernelExC(activity) { \
	args_hipLaunchKernelExC_t* args = (args_hipLaunchKernelExC_t*) activity->args; \
	args->config = (hipLaunchConfig_t *) config; \
	args->fPtr = (void *) fPtr; \
	args->args = (void **) args; \
};

#define GET_PTRS_VALUE_hipLaunchKernelExC(args) { \
	args_hipLaunchKernelExC_t* pargs = (args_hipLaunchKernelExC_t*) args; \
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryLoadData` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryLoadData` function call.
 *
 * @struct args_hipLibraryLoadData_t
 *
 * @note 
 *	hipError_t
 *	hipLibraryLoadData (
...
typedef struct {
	...
	struct {
		void* ptr1;
	} jitOptionsValues__ref;
	unsigned int numJitOptions;
	hipLibraryOption * libraryOptions;
	struct {
		hipLibraryOption  val;
	} libraryOptions__ref;
	void ** libraryOptionValues;
	struct {
		void* ptr1;
	} libraryOptionValues__ref;
	unsigned int numLibraryOptions;
	hipError_t retval;
} args_hipLibraryLoadData_t;

#define GET_ARGS_VALUE_hipLibraryLoadData(activity) { \
	args_hipLibraryLoadData_t* args = (args_hipLibraryLoadData_t*) activity->args; \
	args->library = (hipLibrary_t *) library; \
	args->code = (void *) code; \
	args->jitOptions = (hipJitOption *) jitOptions; \
	args->jitOptionsValues = (void **) jitOptionsValues; \
	args->numJitOptions = (unsigned int) numJitOptions; \
	args->libraryOptions = (hipLibraryOption *) libraryOptions; \
	args->libraryOptionValues = (void **) libraryOptionValues; \
	args->numLibraryOptions = (unsigned int) numLibraryOptions; \
};

#define GET_PTRS_VALUE_hipLibraryLoadData(args) { \
	args_hipLibraryLoadData_t* pargs = (args_hipLibraryLoadData_t*) args; \
	if (pargs->library != NULL) { \
		pargs->library__ref.val = *pargs->library; \
	} \
	if (pargs->jitOptions != NULL) { \
		pargs->jitOptions__ref.val = *pargs->jitOptions; \
	} \
	if (pargs->jitOptionsValues != NULL) { \
		pargs->jitOptionsValues__ref.ptr1 = *pargs->jitOptionsValues; \
	} \
	if (pargs->libraryOptions != NULL) { \
		pargs->libraryOptions__ref.val = *pargs->libraryOptions; \
	} \
	if (pargs->libraryOptionValues != NULL) { \
		pargs->libraryOptionValues__ref.ptr1 = *pargs->libraryOptionValues; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipDeviceGetTexture1DLinearMaxWidth` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDeviceGetTexture1DLinearMaxWidth` function call.
 *
 * @struct args_hipDeviceGetTexture1DLinearMaxWidth_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	int device;
	hipError_t retval;
} args_hipDeviceGetTexture1DLinearMaxWidth_t;

#define GET_ARGS_VALUE_hipDeviceGetTexture1DLinearMaxWidth(activity) { \
	args_hipDeviceGetTexture1DLinearMaxWidth_t* args = (args_hipDeviceGetTexture1DLinearMaxWidth_t*) activity->args; \
	args->max_width = (size_t *) max_width; \
	args->desc = (hipChannelFormatDesc *) desc; \
	args->device = (int) device; \
};

#define GET_PTRS_VALUE_hipDeviceGetTexture1DLinearMaxWidth(args) { \
	args_hipDeviceGetTexture1DLinearMaxWidth_t* pargs = (args_hipDeviceGetTexture1DLinearMaxWidth_t*) args; \
	if (pargs->max_width != NULL) { \
		pargs->max_width__ref.val = *pargs->max_width; \
	} \
	if (pargs->desc != NULL) { \
		pargs->desc__ref.val = *pargs->desc; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `hipMemcpy3DBatchAsync` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemcpy3DBatchAsync` function call.
 *
 * @struct args_hipMemcpy3DBatchAsync_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemcpy3DBatchAsync_t;

#define GET_ARGS_VALUE_hipMemcpy3DBatchAsync(activity) { \
	args_hipMemcpy3DBatchAsync_t* args = (args_hipMemcpy3DBatchAsync_t*) activity->args; \
	args->numOps = (size_t) numOps; \
	args->opList = (struct hipMemcpy3DBatchOp *) opList; \
	args->failIdx = (size_t *) failIdx; \
	args->flags = (unsigned long long) flags; \
	args->stream = (hipStream_t) stream; \
};

#define GET_PTRS_VALUE_hipMemcpy3DBatchAsync(args) { \
	args_hipMemcpy3DBatchAsync_t* pargs = (args_hipMemcpy3DBatchAsync_t*) args; \
	if (pargs->opList != NULL) { \
		pargs->opList__ref.val = *pargs->opList; \
	} \
	if (pargs->failIdx != NULL) { \
		pargs->failIdx__ref.val = *pargs->failIdx; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLinkCreate` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLinkCreate` function call.
 *
 * @struct args_hipLinkCreate_t
 *
 * @note 
 *	hipError_t
 *	hipLinkCreate (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLinkCreate_t;

#define GET_ARGS_VALUE_hipLinkCreate(activity) { \
	args_hipLinkCreate_t* args = (args_hipLinkCreate_t*) activity->args; \
	args->numOptions = (unsigned int) numOptions; \
	args->options = (hipJitOption *) options; \
	args->optionValues = (void **) optionValues; \
	args->stateOut = (hipLinkState_t *) stateOut; \
};

#define GET_PTRS_VALUE_hipLinkCreate(args) { \
	args_hipLinkCreate_t* pargs = (args_hipLinkCreate_t*) args; \
	if (pargs->options != NULL) { \
		pargs->options__ref.val = *pargs->options; \
	} \
	if (pargs->optionValues != NULL) { \
	...
	if (pargs->stateOut != NULL) { \
		pargs->stateOut__ref.val = *pargs->stateOut; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D16` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D16` function call.
 *
 * @struct args_hipMemsetD2D16_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D16 (
...
typedef struct {
	...
	size_t height;
	hipError_t retval;
} args_hipMemsetD2D16_t;

#define GET_ARGS_VALUE_hipMemsetD2D16(activity) { \
	args_hipMemsetD2D16_t* args = (args_hipMemsetD2D16_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
	args->value = (unsigned short) value; \
	args->width = (size_t) width; \
	args->height = (size_t) height; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLinkComplete` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLinkComplete` function call.
 *
 * @struct args_hipLinkComplete_t
 *
 * @note 
 *	hipError_t
 *	hipLinkComplete (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLinkComplete_t;

#define GET_ARGS_VALUE_hipLinkComplete(activity) { \
	args_hipLinkComplete_t* args = (args_hipLinkComplete_t*) activity->args; \
	args->state = (hipLinkState_t) state; \
	args->hipBinOut = (void **) hipBinOut; \
	args->sizeOut = (size_t *) sizeOut; \
};

#define GET_PTRS_VALUE_hipLinkComplete(args) { \
	args_hipLinkComplete_t* pargs = (args_hipLinkComplete_t*) args; \
	if (pargs->hipBinOut != NULL) { \
		pargs->hipBinOut__ref.ptr1 = *pargs->hipBinOut; \
	} \
	if (pargs->sizeOut != NULL) { \
		pargs->sizeOut__ref.val = *pargs->sizeOut; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D16Async` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D16Async` function call.
 *
 * @struct args_hipMemsetD2D16Async_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D16Async (
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemsetD2D16Async_t;

#define GET_ARGS_VALUE_hipMemsetD2D16Async(activity) { \
	args_hipMemsetD2D16Async_t* args = (args_hipMemsetD2D16Async_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
	args->value = (unsigned short) value; \
	args->width = (size_t) width; \
...
#define GET_PTRS_VALUE_hipModuleGetFunction(args) { \
	...
	if (pargs->kname != NULL) { \
		pargs->kname__ref.val = *pargs->kname; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipDrvGraphExecMemcpyNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvGraphExecMemcpyNodeSetParams` function call.
 *
 * @struct args_hipDrvGraphExecMemcpyNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipCtx_t ctx;
	hipError_t retval;
} args_hipDrvGraphExecMemcpyNodeSetParams_t;

#define GET_ARGS_VALUE_hipDrvGraphExecMemcpyNodeSetParams(activity) { \
	args_hipDrvGraphExecMemcpyNodeSetParams_t* args = (args_hipDrvGraphExecMemcpyNodeSetParams_t*) activity->args; \
	args->hGraphExec = (hipGraphExec_t) hGraphExec; \
	args->hNode = (hipGraphNode_t) hNode; \
...
#define GET_PTRS_VALUE_hipDrvGraphExecMemcpyNodeSetParams(args) { \
	args_hipDrvGraphExecMemcpyNodeSetParams_t* pargs = (args_hipDrvGraphExecMemcpyNodeSetParams_t*) args; \
...
#define GET_PTRS_VALUE_hipDeviceGetPCIBusId(args) { \
	...
	if (pargs->pciBusId != NULL) { \
		pargs->pciBusId__ref.val = *pargs->pciBusId; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipStreamCopyAttributes` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipStreamCopyAttributes` function call.
 *
 * @struct args_hipStreamCopyAttributes_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipStream_t src;
	hipError_t retval;
} args_hipStreamCopyAttributes_t;

#define GET_ARGS_VALUE_hipStreamCopyAttributes(activity) { \
	args_hipStreamCopyAttributes_t* args = (args_hipStreamCopyAttributes_t*) activity->args; \
	args->dst = (hipStream_t) dst; \
	args->src = (hipStream_t) src; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGraphNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphNodeSetParams` function call.
 *
 * @struct args_hipGraphNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphNodeSetParams_t;

#define GET_ARGS_VALUE_hipGraphNodeSetParams(activity) { \
	args_hipGraphNodeSetParams_t* args = (args_hipGraphNodeSetParams_t*) activity->args; \
	args->node = (hipGraphNode_t) node; \
	args->nodeParams = (hipGraphNodeParams *) nodeParams; \
};

#define GET_PTRS_VALUE_hipGraphNodeSetParams(args) { \
	args_hipGraphNodeSetParams_t* pargs = (args_hipGraphNodeSetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
#define GET_PTRS_VALUE_hipGraphDebugDotPrint(args) { \
	...
	if (pargs->path != NULL) { \
		pargs->path__ref.val = *pargs->path; \
	} \
};
...
#define GET_PTRS_VALUE_hipGraphInstantiate(args) { \
	...
	if (pargs->pLogBuffer != NULL) { \
		pargs->pLogBuffer__ref.val = *pargs->pLogBuffer; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D8Async` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D8Async` function call.
 *
 * @struct args_hipMemsetD2D8Async_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D8Async (
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemsetD2D8Async_t;

#define GET_ARGS_VALUE_hipMemsetD2D8Async(activity) { \
	args_hipMemsetD2D8Async_t* args = (args_hipMemsetD2D8Async_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryLoadFromFile` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryLoadFromFile` function call.
 *
 * @struct args_hipLibraryLoadFromFile_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	unsigned int numLibraryOptions;
	hipError_t retval;
} args_hipLibraryLoadFromFile_t;

#define GET_ARGS_VALUE_hipLibraryLoadFromFile(activity) { \
	args_hipLibraryLoadFromFile_t* args = (args_hipLibraryLoadFromFile_t*) activity->args; \
	args->library = (hipLibrary_t *) library; \
...
#define GET_PTRS_VALUE_hipLibraryLoadFromFile(args) { \
	args_hipLibraryLoadFromFile_t* pargs = (args_hipLibraryLoadFromFile_t*) args; \
	if (pargs->library != NULL) { \
		pargs->library__ref.val = *pargs->library; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `hipGraphAddBatchMemOpNode` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphAddBatchMemOpNode` function call.
 *
 * @struct args_hipGraphAddBatchMemOpNode_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphAddBatchMemOpNode_t;

#define GET_ARGS_VALUE_hipGraphAddBatchMemOpNode(activity) { \
	args_hipGraphAddBatchMemOpNode_t* args = (args_hipGraphAddBatchMemOpNode_t*) activity->args; \
	args->phGraphNode = (hipGraphNode_t *) phGraphNode; \
	args->hGraph = (hipGraph_t) hGraph; \
	args->dependencies = (hipGraphNode_t *) dependencies; \
	args->numDependencies = (size_t) numDependencies; \
...
#define GET_PTRS_VALUE_hipGraphAddBatchMemOpNode(args) { \
	args_hipGraphAddBatchMemOpNode_t* pargs = (args_hipGraphAddBatchMemOpNode_t*) args; \
	if (pargs->phGraphNode != NULL) { \
		pargs->phGraphNode__ref.val = *pargs->phGraphNode; \
	} \
	if (pargs->dependencies != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D8` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D8` function call.
 *
 * @struct args_hipMemsetD2D8_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D8 (
...
typedef struct {
	...
	size_t height;
	hipError_t retval;
} args_hipMemsetD2D8_t;

#define GET_ARGS_VALUE_hipMemsetD2D8(activity) { \
	args_hipMemsetD2D8_t* args = (args_hipMemsetD2D8_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
	args->value = (unsigned char) value; \
	args->width = (size_t) width; \
...
#define GET_ARGS_VALUE_hipCtxGetApiVersion(activity) { \
	...
	args->ctx = (hipCtx_t) ctx; \
	args->apiVersion = (unsigned int *) apiVersion; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemPrefetchAsync_v2` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemPrefetchAsync_v2` function call.
 *
 * @struct args_hipMemPrefetchAsync_v2_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemPrefetchAsync_v2_t;

#define GET_ARGS_VALUE_hipMemPrefetchAsync_v2(activity) { \
	args_hipMemPrefetchAsync_v2_t* args = (args_hipMemPrefetchAsync_v2_t*) activity->args; \
	args->dev_ptr = (void *) dev_ptr; \
	args->count = (size_t) count; \
	args->location = (hipMemLocation) location; \
	args->flags = (unsigned int) flags; \
...
/**
 * @brief Structure to hold the arguments for the `hipLinkDestroy` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLinkDestroy` function call.
 *
 * @struct args_hipLinkDestroy_t
 *
 * @note 
 *	hipError_t
 *	hipLinkDestroy (
...
typedef struct {
	hipLinkState_t state;
	hipError_t retval;
} args_hipLinkDestroy_t;

#define GET_ARGS_VALUE_hipLinkDestroy(activity) { \
	args_hipLinkDestroy_t* args = (args_hipLinkDestroy_t*) activity->args; \
	args->state = (hipLinkState_t) state; \
};
...
#define GET_PTRS_VALUE_hipDrvGetErrorName(args) { \
	...
	if (pargs->errorString != NULL) { \
		...
		if (pargs->errorString__ref.ptr1 != NULL) { \
			pargs->errorString__ref.val = **pargs->errorString; \
		} \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipEventRecordWithFlags` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipEventRecordWithFlags` function call.
 *
 * @struct args_hipEventRecordWithFlags_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	unsigned int flags;
	hipError_t retval;
} args_hipEventRecordWithFlags_t;

#define GET_ARGS_VALUE_hipEventRecordWithFlags(activity) { \
	args_hipEventRecordWithFlags_t* args = (args_hipEventRecordWithFlags_t*) activity->args; \
	args->event = (hipEvent_t) event; \
	args->stream = (hipStream_t) stream; \
	args->flags = (unsigned int) flags; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryEnumerateKernels` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryEnumerateKernels` function call.
 *
 * @struct args_hipLibraryEnumerateKernels_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipLibrary_t library;
	hipError_t retval;
} args_hipLibraryEnumerateKernels_t;

#define GET_ARGS_VALUE_hipLibraryEnumerateKernels(activity) { \
	args_hipLibraryEnumerateKernels_t* args = (args_hipLibraryEnumerateKernels_t*) activity->args; \
	args->kernels = (hipKernel_t *) kernels; \
	args->numKernels = (unsigned int) numKernels; \
	args->library = (hipLibrary_t) library; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLinkAddData` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLinkAddData` function call.
 *
 * @struct args_hipLinkAddData_t
 *
 * @note 
 *	hipError_t
 *	hipLinkAddData (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLinkAddData_t;

#define GET_ARGS_VALUE_hipLinkAddData(activity) { \
	args_hipLinkAddData_t* args = (args_hipLinkAddData_t*) activity->args; \
	args->state = (hipLinkState_t) state; \
	args->type = (hipJitInputType) type; \
	args->data = (void *) data; \
	args->size = (size_t) size; \
	args->name = (char *) name; \
	args->numOptions = (unsigned int) numOptions; \
...
#define GET_PTRS_VALUE_hipLinkAddData(args) { \
	args_hipLinkAddData_t* pargs = (args_hipLinkAddData_t*) args; \
	if (pargs->name != NULL) { \
		pargs->name__ref.val = *pargs->name; \
	} \
	if (pargs->options != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipDrvGraphAddMemFreeNode` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvGraphAddMemFreeNode` function call.
 *
 * @struct args_hipDrvGraphAddMemFreeNode_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	void * dptr;
	hipError_t retval;
} args_hipDrvGraphAddMemFreeNode_t;

#define GET_ARGS_VALUE_hipDrvGraphAddMemFreeNode(activity) { \
	args_hipDrvGraphAddMemFreeNode_t* args = (args_hipDrvGraphAddMemFreeNode_t*) activity->args; \
	args->phGraphNode = (hipGraphNode_t *) phGraphNode; \
	args->hGraph = (hipGraph_t) hGraph; \
	args->dependencies = (hipGraphNode_t *) dependencies; \
	args->numDependencies = (size_t) numDependencies; \
...
/**
 * @brief Structure to hold the arguments for the `hipGetDriverEntryPoint_spt` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGetDriverEntryPoint_spt` function call.
 *
 * @struct args_hipGetDriverEntryPoint_spt_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGetDriverEntryPoint_spt_t;

#define GET_ARGS_VALUE_hipGetDriverEntryPoint_spt(activity) { \
	args_hipGetDriverEntryPoint_spt_t* args = (args_hipGetDriverEntryPoint_spt_t*) activity->args; \
	args->symbol = (char *) symbol; \
	args->funcPtr = (void **) funcPtr; \
	args->flags = (unsigned long long) flags; \
	args->status = (hipDriverEntryPointQueryResult *) status; \
};

#define GET_PTRS_VALUE_hipGetDriverEntryPoint_spt(args) { \
	args_hipGetDriverEntryPoint_spt_t* pargs = (args_hipGetDriverEntryPoint_spt_t*) args; \
	if (pargs->symbol != NULL) { \
		pargs->symbol__ref.val = *pargs->symbol; \
	} \
	if (pargs->funcPtr != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipGraphExecBatchMemOpNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphExecBatchMemOpNodeSetParams` function call.
 *
 * @struct args_hipGraphExecBatchMemOpNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphExecBatchMemOpNodeSetParams_t;

#define GET_ARGS_VALUE_hipGraphExecBatchMemOpNodeSetParams(activity) { \
	args_hipGraphExecBatchMemOpNodeSetParams_t* args = (args_hipGraphExecBatchMemOpNodeSetParams_t*) activity->args; \
	args->hGraphExec = (hipGraphExec_t) hGraphExec; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->nodeParams = (hipBatchMemOpNodeParams *) nodeParams; \
};

#define GET_PTRS_VALUE_hipGraphExecBatchMemOpNodeSetParams(args) { \
	args_hipGraphExecBatchMemOpNodeSetParams_t* pargs = (args_hipGraphExecBatchMemOpNodeSetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemcpyBatchAsync` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemcpyBatchAsync` function call.
 *
 * @struct args_hipMemcpyBatchAsync_t
 *
 * @note 
 *	hipError_t
 *	hipMemcpyBatchAsync (
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemcpyBatchAsync_t;

#define GET_ARGS_VALUE_hipMemcpyBatchAsync(activity) { \
	args_hipMemcpyBatchAsync_t* args = (args_hipMemcpyBatchAsync_t*) activity->args; \
	args->dsts = (void **) dsts; \
	args->srcs = (void **) srcs; \
	args->sizes = (size_t *) sizes; \
	args->count = (size_t) count; \
	args->attrs = (hipMemcpyAttributes *) attrs; \
	args->attrsIdxs = (size_t *) attrsIdxs; \
	args->numAttrs = (size_t) numAttrs; \
	args->failIdx = (size_t *) failIdx; \
	args->stream = (hipStream_t) stream; \
};

#define GET_PTRS_VALUE_hipMemcpyBatchAsync(args) { \
	args_hipMemcpyBatchAsync_t* pargs = (args_hipMemcpyBatchAsync_t*) args; \
	if (pargs->dsts != NULL) { \
		pargs->dsts__ref.ptr1 = *pargs->dsts; \
	} \
	if (pargs->srcs != NULL) { \
		pargs->srcs__ref.ptr1 = *pargs->srcs; \
	} \
	if (pargs->sizes != NULL) { \
		pargs->sizes__ref.val = *pargs->sizes; \
	} \
	if (pargs->attrs != NULL) { \
		pargs->attrs__ref.val = *pargs->attrs; \
	} \
	if (pargs->attrsIdxs != NULL) { \
		pargs->attrsIdxs__ref.val = *pargs->attrsIdxs; \
	} \
	if (pargs->failIdx != NULL) { \
		pargs->failIdx__ref.val = *pargs->failIdx; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `hipMemGetHandleForAddressRange` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemGetHandleForAddressRange` function call.
 *
 * @struct args_hipMemGetHandleForAddressRange_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	unsigned long long flags;
	hipError_t retval;
} args_hipMemGetHandleForAddressRange_t;

#define GET_ARGS_VALUE_hipMemGetHandleForAddressRange(activity) { \
	args_hipMemGetHandleForAddressRange_t* args = (args_hipMemGetHandleForAddressRange_t*) activity->args; \
	args->handle = (void *) handle; \
	args->dptr = (void *) dptr; \
	args->size = (size_t) size; \
	args->handleType = (hipMemRangeHandleType) handleType; \
	args->flags = (unsigned long long) flags; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryGetKernelCount` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryGetKernelCount` function call.
 *
 * @struct args_hipLibraryGetKernelCount_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipLibrary_t library;
	hipError_t retval;
} args_hipLibraryGetKernelCount_t;

#define GET_ARGS_VALUE_hipLibraryGetKernelCount(activity) { \
	args_hipLibraryGetKernelCount_t* args = (args_hipLibraryGetKernelCount_t*) activity->args; \
	args->count = (unsigned int *) count; \
	args->library = (hipLibrary_t) library; \
};

#define GET_PTRS_VALUE_hipLibraryGetKernelCount(args) { \
	args_hipLibraryGetKernelCount_t* pargs = (args_hipLibraryGetKernelCount_t*) args; \
	if (pargs->count != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipStreamGetAttribute` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipStreamGetAttribute` function call.
 *
 * @struct args_hipStreamGetAttribute_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipStreamGetAttribute_t;

#define GET_ARGS_VALUE_hipStreamGetAttribute(activity) { \
	args_hipStreamGetAttribute_t* args = (args_hipStreamGetAttribute_t*) activity->args; \
	args->stream = (hipStream_t) stream; \
	args->attr = (hipLaunchAttributeID) attr; \
	args->value_out = (hipLaunchAttributeValue *) value_out; \
};

#define GET_PTRS_VALUE_hipStreamGetAttribute(args) { \
	args_hipStreamGetAttribute_t* pargs = (args_hipStreamGetAttribute_t*) args; \
	if (pargs->value_out != NULL) { \
		pargs->value_out__ref.val = *pargs->value_out; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLibraryGetKernel` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLibraryGetKernel` function call.
 *
 * @struct args_hipLibraryGetKernel_t
 *
 * @note 
 *	hipError_t
 *	hipLibraryGetKernel (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLibraryGetKernel_t;

#define GET_ARGS_VALUE_hipLibraryGetKernel(activity) { \
	args_hipLibraryGetKernel_t* args = (args_hipLibraryGetKernel_t*) activity->args; \
	args->pKernel = (hipKernel_t *) pKernel; \
	args->library = (hipLibrary_t) library; \
	args->name = (char *) name; \
};

#define GET_PTRS_VALUE_hipLibraryGetKernel(args) { \
	args_hipLibraryGetKernel_t* pargs = (args_hipLibraryGetKernel_t*) args; \
	if (pargs->pKernel != NULL) { \
		pargs->pKernel__ref.val = *pargs->pKernel; \
	} \
	if (pargs->name != NULL) { \
		pargs->name__ref.val = *pargs->name; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D32Async` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D32Async` function call.
 *
 * @struct args_hipMemsetD2D32Async_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D32Async (
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemsetD2D32Async_t;

#define GET_ARGS_VALUE_hipMemsetD2D32Async(activity) { \
	args_hipMemsetD2D32Async_t* args = (args_hipMemsetD2D32Async_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
	args->value = (unsigned int) value; \
	args->width = (size_t) width; \
	args->height = (size_t) height; \
	args->stream = (hipStream_t) stream; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipModuleGetFunctionCount` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipModuleGetFunctionCount` function call.
 *
 * @struct args_hipModuleGetFunctionCount_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipModule_t mod;
	hipError_t retval;
} args_hipModuleGetFunctionCount_t;

#define GET_ARGS_VALUE_hipModuleGetFunctionCount(activity) { \
	args_hipModuleGetFunctionCount_t* args = (args_hipModuleGetFunctionCount_t*) activity->args; \
	args->count = (unsigned int *) count; \
	args->mod = (hipModule_t) mod; \
};

#define GET_PTRS_VALUE_hipModuleGetFunctionCount(args) { \
	args_hipModuleGetFunctionCount_t* pargs = (args_hipModuleGetFunctionCount_t*) args; \
	if (pargs->count != NULL) { \
		pargs->count__ref.val = *pargs->count; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGraphExecNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphExecNodeSetParams` function call.
 *
 * @struct args_hipGraphExecNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphExecNodeSetParams_t;

#define GET_ARGS_VALUE_hipGraphExecNodeSetParams(activity) { \
	args_hipGraphExecNodeSetParams_t* args = (args_hipGraphExecNodeSetParams_t*) activity->args; \
	args->graphExec = (hipGraphExec_t) graphExec; \
	args->node = (hipGraphNode_t) node; \
	args->nodeParams = (hipGraphNodeParams *) nodeParams; \
};

#define GET_PTRS_VALUE_hipGraphExecNodeSetParams(args) { \
	args_hipGraphExecNodeSetParams_t* pargs = (args_hipGraphExecNodeSetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipGraphBatchMemOpNodeGetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGraphBatchMemOpNodeGetParams` function call.
 *
 * @struct args_hipGraphBatchMemOpNodeGetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipGraphBatchMemOpNodeGetParams_t;

#define GET_ARGS_VALUE_hipGraphBatchMemOpNodeGetParams(activity) { \
	args_hipGraphBatchMemOpNodeGetParams_t* args = (args_hipGraphBatchMemOpNodeGetParams_t*) activity->args; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->nodeParams_out = (hipBatchMemOpNodeParams *) nodeParams_out; \
};

#define GET_PTRS_VALUE_hipGraphBatchMemOpNodeGetParams(args) { \
	args_hipGraphBatchMemOpNodeGetParams_t* pargs = (args_hipGraphBatchMemOpNodeGetParams_t*) args; \
	if (pargs->nodeParams_out != NULL) { \
		pargs->nodeParams_out__ref.val = *pargs->nodeParams_out; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipDrvGraphMemcpyNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvGraphMemcpyNodeSetParams` function call.
 *
 * @struct args_hipDrvGraphMemcpyNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipDrvGraphMemcpyNodeSetParams_t;

#define GET_ARGS_VALUE_hipDrvGraphMemcpyNodeSetParams(activity) { \
	args_hipDrvGraphMemcpyNodeSetParams_t* args = (args_hipDrvGraphMemcpyNodeSetParams_t*) activity->args; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->nodeParams = (HIP_MEMCPY3D *) nodeParams; \
};

#define GET_PTRS_VALUE_hipDrvGraphMemcpyNodeSetParams(args) { \
	args_hipDrvGraphMemcpyNodeSetParams_t* pargs = (args_hipDrvGraphMemcpyNodeSetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipLinkAddFile` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipLinkAddFile` function call.
 *
 * @struct args_hipLinkAddFile_t
 *
 * @note 
 *	hipError_t
 *	hipLinkAddFile (
...
typedef struct {
	...
	hipError_t retval;
} args_hipLinkAddFile_t;

#define GET_ARGS_VALUE_hipLinkAddFile(activity) { \
	args_hipLinkAddFile_t* args = (args_hipLinkAddFile_t*) activity->args; \
	args->state = (hipLinkState_t) state; \
	args->type = (hipJitInputType) type; \
	args->path = (char *) path; \
	args->numOptions = (unsigned int) numOptions; \
...
#define GET_PTRS_VALUE_hipLinkAddFile(args) { \
	args_hipLinkAddFile_t* pargs = (args_hipLinkAddFile_t*) args; \
	if (pargs->path != NULL) { \
		pargs->path__ref.val = *pargs->path; \
	} \
	if (pargs->options != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipDrvLaunchKernelEx` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvLaunchKernelEx` function call.
 *
 * @struct args_hipDrvLaunchKernelEx_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipDrvLaunchKernelEx_t;

#define GET_ARGS_VALUE_hipDrvLaunchKernelEx(activity) { \
	args_hipDrvLaunchKernelEx_t* args = (args_hipDrvLaunchKernelEx_t*) activity->args; \
	args->config = (HIP_LAUNCH_CONFIG *) config; \
	args->f = (hipFunction_t) f; \
	args->params = (void **) params; \
	args->extra = (void **) extra; \
};

#define GET_PTRS_VALUE_hipDrvLaunchKernelEx(args) { \
	args_hipDrvLaunchKernelEx_t* pargs = (args_hipDrvLaunchKernelEx_t*) args; \
	if (pargs->config != NULL) { \
		pargs->config__ref.val = *pargs->config; \
	} \
	if (pargs->params != NULL) { \
		pargs->params__ref.ptr1 = *pargs->params; \
	} \
	if (pargs->extra != NULL) { \
		pargs->extra__ref.ptr1 = *pargs->extra; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `hipMemcpy3DPeer` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemcpy3DPeer` function call.
 *
 * @struct args_hipMemcpy3DPeer_t
 *
 * @note 
 *	hipError_t
 *	hipMemcpy3DPeer (
...
typedef struct {
	...
	struct {
		hipMemcpy3DPeerParms  val;
	} p__ref;
	hipError_t retval;
} args_hipMemcpy3DPeer_t;

#define GET_ARGS_VALUE_hipMemcpy3DPeer(activity) { \
	args_hipMemcpy3DPeer_t* args = (args_hipMemcpy3DPeer_t*) activity->args; \
	args->p = (hipMemcpy3DPeerParms *) p; \
};

#define GET_PTRS_VALUE_hipMemcpy3DPeer(args) { \
	args_hipMemcpy3DPeer_t* pargs = (args_hipMemcpy3DPeer_t*) args; \
	if (pargs->p != NULL) { \
		pargs->p__ref.val = *pargs->p; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipStreamBatchMemOp` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipStreamBatchMemOp` function call.
 *
 * @struct args_hipStreamBatchMemOp_t
 *
 * @note 
 *	hipError_t
 *	hipStreamBatchMemOp (
...
typedef struct {
	...
	struct {
		hipStreamBatchMemOpParams  val;
	} paramArray__ref;
	unsigned int flags;
	hipError_t retval;
} args_hipStreamBatchMemOp_t;

#define GET_ARGS_VALUE_hipStreamBatchMemOp(activity) { \
	args_hipStreamBatchMemOp_t* args = (args_hipStreamBatchMemOp_t*) activity->args; \
	args->stream = (hipStream_t) stream; \
	args->count = (unsigned int) count; \
	args->paramArray = (hipStreamBatchMemOpParams *) paramArray; \
	args->flags = (unsigned int) flags; \
};

#define GET_PTRS_VALUE_hipStreamBatchMemOp(args) { \
	args_hipStreamBatchMemOp_t* pargs = (args_hipStreamBatchMemOp_t*) args; \
	if (pargs->paramArray != NULL) { \
		pargs->paramArray__ref.val = *pargs->paramArray; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemsetD2D32` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemsetD2D32` function call.
 *
 * @struct args_hipMemsetD2D32_t
 *
 * @note 
 *	hipError_t
 *	hipMemsetD2D32 (
...
typedef struct {
	...
	size_t height;
	hipError_t retval;
} args_hipMemsetD2D32_t;

#define GET_ARGS_VALUE_hipMemsetD2D32(activity) { \
	args_hipMemsetD2D32_t* args = (args_hipMemsetD2D32_t*) activity->args; \
	args->dst = (void *) dst; \
	args->dstPitch = (size_t) dstPitch; \
	args->value = (unsigned int) value; \
	args->width = (size_t) width; \
...
/**
 * @brief Structure to hold the arguments for the `hipDrvGraphMemcpyNodeGetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvGraphMemcpyNodeGetParams` function call.
 *
 * @struct args_hipDrvGraphMemcpyNodeGetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipError_t retval;
} args_hipDrvGraphMemcpyNodeGetParams_t;

#define GET_ARGS_VALUE_hipDrvGraphMemcpyNodeGetParams(activity) { \
	args_hipDrvGraphMemcpyNodeGetParams_t* args = (args_hipDrvGraphMemcpyNodeGetParams_t*) activity->args; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->nodeParams = (HIP_MEMCPY3D *) nodeParams; \
};

#define GET_PTRS_VALUE_hipDrvGraphMemcpyNodeGetParams(args) { \
	args_hipDrvGraphMemcpyNodeGetParams_t* pargs = (args_hipDrvGraphMemcpyNodeGetParams_t*) args; \
	if (pargs->nodeParams != NULL) { \
		pargs->nodeParams__ref.val = *pargs->nodeParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipOccupancyAvailableDynamicSMemPerBlock` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipOccupancyAvailableDynamicSMemPerBlock` function call.
 *
 * @struct args_hipOccupancyAvailableDynamicSMemPerBlock_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	struct {
		size_t  val;
	} dynamicSmemSize__ref;
	void * f;
	int numBlocks;
	int blockSize;
	hipError_t retval;
} args_hipOccupancyAvailableDynamicSMemPerBlock_t;

#define GET_ARGS_VALUE_hipOccupancyAvailableDynamicSMemPerBlock(activity) { \
	args_hipOccupancyAvailableDynamicSMemPerBlock_t* args = (args_hipOccupancyAvailableDynamicSMemPerBlock_t*) activity->args; \
	args->dynamicSmemSize = (size_t *) dynamicSmemSize; \
	args->f = (void *) f; \
	args->numBlocks = (int) numBlocks; \
	args->blockSize = (int) blockSize; \
};

#define GET_PTRS_VALUE_hipOccupancyAvailableDynamicSMemPerBlock(args) { \
	args_hipOccupancyAvailableDynamicSMemPerBlock_t* pargs = (args_hipOccupancyAvailableDynamicSMemPerBlock_t*) args; \
	if (pargs->dynamicSmemSize != NULL) { \
		pargs->dynamicSmemSize__ref.val = *pargs->dynamicSmemSize; \
	} \
};
...
#define GET_ARGS_VALUE_hipDrvGraphAddMemsetNode(activity) { \
	...
	args->dependencies = (hipGraphNode_t *) dependencies; \
	args->numDependencies = (size_t) numDependencies; \
	args->memsetParams = (hipMemsetParams *) memsetParams; \
	args->ctx = (hipCtx_t) ctx; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipModuleLoadFatBinary` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipModuleLoadFatBinary` function call.
 *
 * @struct args_hipModuleLoadFatBinary_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	void * fatbin;
	hipError_t retval;
} args_hipModuleLoadFatBinary_t;

#define GET_ARGS_VALUE_hipModuleLoadFatBinary(activity) { \
	args_hipModuleLoadFatBinary_t* args = (args_hipModuleLoadFatBinary_t*) activity->args; \
	args->module = (hipModule_t *) module; \
	args->fatbin = (void *) fatbin; \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemcpy3DPeerAsync` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemcpy3DPeerAsync` function call.
 *
 * @struct args_hipMemcpy3DPeerAsync_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipStream_t stream;
	hipError_t retval;
} args_hipMemcpy3DPeerAsync_t;

#define GET_ARGS_VALUE_hipMemcpy3DPeerAsync(activity) { \
	args_hipMemcpy3DPeerAsync_t* args = (args_hipMemcpy3DPeerAsync_t*) activity->args; \
	args->p = (hipMemcpy3DPeerParms *) p; \
	args->stream = (hipStream_t) stream; \
};

#define GET_PTRS_VALUE_hipMemcpy3DPeerAsync(args) { \
	args_hipMemcpy3DPeerAsync_t* pargs = (args_hipMemcpy3DPeerAsync_t*) args; \
	if (pargs->p != NULL) { \
		pargs->p__ref.val = *pargs->p; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipKernelGetName` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipKernelGetName` function call.
 *
 * @struct args_hipKernelGetName_t
 *
 * @note 
 *	hipError_t
 *	hipKernelGetName (
...
typedef struct {
	...
	hipKernel_t kernel;
	hipError_t retval;
} args_hipKernelGetName_t;

#define GET_ARGS_VALUE_hipKernelGetName(activity) { \
	args_hipKernelGetName_t* args = (args_hipKernelGetName_t*) activity->args; \
	args->name = (char **) name; \
	args->kernel = (hipKernel_t) kernel; \
};

#define GET_PTRS_VALUE_hipKernelGetName(args) { \
	args_hipKernelGetName_t* pargs = (args_hipKernelGetName_t*) args; \
	if (pargs->name != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipDrvGraphExecMemsetNodeSetParams` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipDrvGraphExecMemsetNodeSetParams` function call.
 *
 * @struct args_hipDrvGraphExecMemsetNodeSetParams_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	hipCtx_t ctx;
	hipError_t retval;
} args_hipDrvGraphExecMemsetNodeSetParams_t;

#define GET_ARGS_VALUE_hipDrvGraphExecMemsetNodeSetParams(activity) { \
	args_hipDrvGraphExecMemsetNodeSetParams_t* args = (args_hipDrvGraphExecMemsetNodeSetParams_t*) activity->args; \
	args->hGraphExec = (hipGraphExec_t) hGraphExec; \
	args->hNode = (hipGraphNode_t) hNode; \
	args->memsetParams = (hipMemsetParams *) memsetParams; \
	args->ctx = (hipCtx_t) ctx; \
...
#define GET_PTRS_VALUE_hipDrvGraphExecMemsetNodeSetParams(args) { \
	args_hipDrvGraphExecMemsetNodeSetParams_t* pargs = (args_hipDrvGraphExecMemsetNodeSetParams_t*) args; \
	if (pargs->memsetParams != NULL) { \
		pargs->memsetParams__ref.val = *pargs->memsetParams; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `hipMemAdvise_v2` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipMemAdvise_v2` function call.
 *
 * @struct args_hipMemAdvise_v2_t
 *
 * @note 
 *	hipError_t
 *	hipMemAdvise_v2 (
...
typedef struct {
	...
	hipMemLocation location;
	hipError_t retval;
} args_hipMemAdvise_v2_t;

#define GET_ARGS_VALUE_hipMemAdvise_v2(activity) { \
	args_hipMemAdvise_v2_t* args = (args_hipMemAdvise_v2_t*) activity->args; \
	args->dev_ptr = (void *) dev_ptr; \
	args->count = (size_t) count; \
	args->advice = (hipMemoryAdvise) advice; \
	args->location = (hipMemLocation) location; \
...
/**
 * @brief Structure to hold the arguments for the `hipChooseDevice` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipChooseDevice` function call.
 *
 * @struct args_hipChooseDevice_t
 *
 * @note 
 *	hipError_t
 *	hipChooseDevice (
...
typedef struct {
	...
	hipError_t retval;
} args_hipChooseDevice_t;

#define GET_ARGS_VALUE_hipChooseDevice(activity) { \
	args_hipChooseDevice_t* args = (args_hipChooseDevice_t*) activity->args; \
	args->device = (int *) device; \
	args->prop = (hipDeviceProp_t *) prop; \
};

#define GET_PTRS_VALUE_hipChooseDevice(args) { \
	args_hipChooseDevice_t* pargs = (args_hipChooseDevice_t*) args; \
	if (pargs->device != NULL) { \
		pargs->device__ref.val = *pargs->device; \
	} \
	if (pargs->prop != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipExtModuleLaunchKernel` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipExtModuleLaunchKernel` function call.
 *
 * @struct args_hipExtModuleLaunchKernel_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	uint32_t flags;
	hipError_t retval;
} args_hipExtModuleLaunchKernel_t;

#define GET_ARGS_VALUE_hipExtModuleLaunchKernel(activity) { \
	args_hipExtModuleLaunchKernel_t* args = (args_hipExtModuleLaunchKernel_t*) activity->args; \
	args->f = (hipFunction_t) f; \
	args->globalWorkSizeX = (uint32_t) globalWorkSizeX; \
	args->globalWorkSizeY = (uint32_t) globalWorkSizeY; \
	args->globalWorkSizeZ = (uint32_t) globalWorkSizeZ; \
	args->localWorkSizeX = (uint32_t) localWorkSizeX; \
	args->localWorkSizeY = (uint32_t) localWorkSizeY; \
	args->localWorkSizeZ = (uint32_t) localWorkSizeZ; \
	args->sharedMemBytes = (size_t) sharedMemBytes; \
	args->hStream = (hipStream_t) hStream; \
	args->kernelParams = (void **) kernelParams; \
	args->extra = (void **) extra; \
...
#define GET_PTRS_VALUE_hipExtModuleLaunchKernel(args) { \
	args_hipExtModuleLaunchKernel_t* pargs = (args_hipExtModuleLaunchKernel_t*) args; \
	if (pargs->kernelParams != NULL) { \
		pargs->kernelParams__ref.ptr1 = *pargs->kernelParams; \
	} \
	if (pargs->extra != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `hipGetDeviceProperties` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `hipGetDeviceProperties` function call.
 *
 * @struct args_hipGetDeviceProperties_t
 *
 * @note 
 *	hipError_t
...
typedef struct {
	...
	int deviceId;
	hipError_t retval;
} args_hipGetDeviceProperties_t;

#define GET_ARGS_VALUE_hipGetDeviceProperties(activity) { \
	args_hipGetDeviceProperties_t* args = (args_hipGetDeviceProperties_t*) activity->args; \
	args->prop = (hipDeviceProp_t *) prop; \
	args->deviceId = (int) deviceId; \
};

#define GET_PTRS_VALUE_hipGetDeviceProperties(args) { \
	args_hipGetDeviceProperties_t* pargs = (args_hipGetDeviceProperties_t*) args; \
	if (pargs->prop != NULL) { \
		pargs->prop__ref.val = *pargs->prop; \
	} \
};
...
/**
 * @brief Structure to hold the arguments for the `__hipRegisterFatBinary` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterFatBinary` function call.
 *
 * @struct args___hipRegisterFatBinary_t
 *
 * @note 
 *	void*
...
typedef struct {
	void* data;
	void* retval;
} args___hipRegisterFatBinary_t;

#define GET_ARGS_VALUE___hipRegisterFatBinary(activity) { \
	args___hipRegisterFatBinary_t* args = (args___hipRegisterFatBinary_t*) activity->args; \
	args->data = (void*) data; \
};

/**
 * @brief Structure to hold the arguments for the `__hipUnregisterFatBinary` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipUnregisterFatBinary` function call.
 *
 * @struct args___hipUnregisterFatBinary_t
 *
 * @note 
 *	void
...
typedef struct {
	void* module;
} args___hipUnregisterFatBinary_t;

#define GET_ARGS_VALUE___hipUnregisterFatBinary(activity) { \
	args___hipUnregisterFatBinary_t* args = (args___hipUnregisterFatBinary_t*) activity->args; \
	args->module = (void*) module; \
};

/**
 * @brief Structure to hold the arguments for the `__hipRegisterFunction` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterFunction` function call.
 *
 * @struct args___hipRegisterFunction_t
 *
 * @note 
 *	void
...
} args___hipRegisterFunction_t;

#define GET_ARGS_VALUE___hipRegisterFunction(activity) { \
	args___hipRegisterFunction_t* args = (args___hipRegisterFunction_t*) activity->args; \
	args->modules = (void**) modules; \
	args->hostFunction = (void*) hostFunction; \
	args->deviceFunction = (char*) deviceFunction; \
	args->deviceName = (char*) deviceName; \
	args->threadLimit = (unsigned int) threadLimit; \
	args->tid = (uint3*) tid; \
	args->bid = (uint3*) bid; \
	args->blockDim = (dim3*) blockDim; \
	args->gridDim = (dim3*) gridDim; \
	args->wSize = (int*) wSize; \
};

#define GET_PTRS_VALUE___hipRegisterFunction(args) { \
	args___hipRegisterFunction_t* pargs = (args___hipRegisterFunction_t*) args; \
	if (pargs->modules != NULL) { \
		pargs->modules__ref.ptr1 = *pargs->modules; \
	} \
	if (pargs->deviceFunction != NULL) { \
		strncpy(pargs->deviceFunction__ref.val, pargs->deviceFunction, HIP_STRING_SIZE_MAX-1); \
	} \
	if (pargs->deviceName != NULL) { \
		pargs->deviceName__ref.val = *pargs->deviceName; \
	} \
	if (pargs->tid != NULL) { \
		pargs->tid__ref.val = *pargs->tid; \
	} \
	if (pargs->bid != NULL) { \
		pargs->bid__ref.val = *pargs->bid; \
	} \
	if (pargs->blockDim != NULL) { \
		pargs->blockDim__ref.val = *pargs->blockDim; \
	} \
	...
	if (pargs->wSize != NULL) { \
		pargs->wSize__ref.val = *pargs->wSize; \
	} \
};

/**
 * @brief Structure to hold the arguments for the `__hipRegisterManagedVar` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterManagedVar` function call.
 *
 * @struct args___hipRegisterManagedVar_t
 *
 * @note 
 *	void
...
typedef struct {
	...
	size_t size;
	unsigned int align;
} args___hipRegisterManagedVar_t;

#define GET_ARGS_VALUE___hipRegisterManagedVar(activity) { \
	args___hipRegisterManagedVar_t* args = (args___hipRegisterManagedVar_t*) activity->args; \
	args->hipModule = (void*) hipModule; \
	args->pointer = (void**) pointer; \
	args->init_value = (void*) init_value; \
	args->name = (char*) name; \
	args->size = (size_t) size; \
	args->align = (unsigned int) align; \
};

#define GET_PTRS_VALUE___hipRegisterManagedVar(args) { \
	args___hipRegisterManagedVar_t* pargs = (args___hipRegisterManagedVar_t*) args; \
	if (pargs->pointer != NULL) { \
		pargs->pointer__ref.ptr1 = *pargs->pointer; \
	} \
	if (pargs->name != NULL) { \
		pargs->name__ref.val = *pargs->name; \
	} \
...
/**
 * @brief Structure to hold the arguments for the `__hipRegisterVar` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterVar` function call.
 *
 * @struct args___hipRegisterVar_t
 *
 * @note 
 *	void
 *	__hipRegisterVar (
...
typedef struct {
	...
	int constant;
	int global;
} args___hipRegisterVar_t;

#define GET_ARGS_VALUE___hipRegisterVar(activity) { \
	args___hipRegisterVar_t* args = (args___hipRegisterVar_t*) activity->args; \
	args->modules = (void**) modules; \
	args->var = (void*) var; \
	args->hostVar = (char*) hostVar; \
	args->deviceVar = (char*) deviceVar; \
	args->ext = (int) ext; \
	args->size = (size_t) size; \
	args->constant = (int) constant; \
	args->global = (int) global; \
};

#define GET_PTRS_VALUE___hipRegisterVar(args) { \
	args___hipRegisterVar_t* pargs = (args___hipRegisterVar_t*) args; \
	if (pargs->modules != NULL) { \
		pargs->modules__ref.ptr1 = *pargs->modules; \
	} \
	if (pargs->hostVar != NULL) { \
		strncpy(pargs->hostVar__ref.val, pargs->hostVar, HIP_STRING_SIZE_MAX-1); \
	} \
	if (pargs->deviceVar != NULL) { \
		strncpy(pargs->deviceVar__ref.val, pargs->deviceVar, HIP_STRING_SIZE_MAX-1); \
	} \
};

/**
 * @brief Structure to hold the arguments for the `__hipRegisterSurface` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterSurface` function call.
 *
 * @struct args___hipRegisterSurface_t
 *
 * @note 
 *	void
...
typedef struct {
	...
	int type;
	int ext;
} args___hipRegisterSurface_t;

#define GET_ARGS_VALUE___hipRegisterSurface(activity) { \
	args___hipRegisterSurface_t* args = (args___hipRegisterSurface_t*) activity->args; \
	args->modules = (void**) modules; \
	args->var = (void*) var; \
	args->hostVar = (char*) hostVar; \
	args->deviceVar = (char*) deviceVar; \
...
#define GET_PTRS_VALUE___hipRegisterSurface(args) { \
	args___hipRegisterSurface_t* pargs = (args___hipRegisterSurface_t*) args; \
	if (pargs->modules != NULL) { \
		pargs->modules__ref.ptr1 = *pargs->modules; \
	} \
	if (pargs->hostVar != NULL) { \
...
/**
 * @brief Structure to hold the arguments for the `__hipRegisterTexture` function.
 *
 * This structure encapsulates the parameters and return value used in the 
 * `__hipRegisterTexture` function call.
 *
 * @struct args___hipRegisterTexture_t
 *
 * @note 
 *	void
...
typedef struct {
	...
	int norm;
	int ext;
} args___hipRegisterTexture_t;

#define GET_ARGS_VALUE___hipRegisterTexture(activity) { \
	args___hipRegisterTexture_t* args = (args___hipRegisterTexture_t*) activity->args; \
	args->modules = (void**) modules; \
	args->var = (void*) var; \
	args->hostVar = (char*) hostVar; \
	args->deviceVar = (char*) deviceVar; \
...
#define GET_PTRS_VALUE___hipRegisterTexture(args) { \
	args___hipRegisterTexture_t* pargs = (args___hipRegisterTexture_t*) args; \
	if (pargs->modules != NULL) { \
		pargs->modules__ref.ptr1 = *pargs->modules; \
	} \
	if (pargs->hostVar != NULL) { \
    ...
    if (!is_enter) {
        switch(id) {
			...
			case HIP_API_ID_hipStreamSetAttribute : {
				GET_PTRS_VALUE_hipStreamSetAttribute(args);
				return;
			}
			...
			case HIP_API_ID_hipStreamGetId : {
				GET_PTRS_VALUE_hipStreamGetId(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphBatchMemOpNodeSetParams : {
				GET_PTRS_VALUE_hipGraphBatchMemOpNodeSetParams(args);
				return;
			}
			case HIP_API_ID_hipGetDriverEntryPoint : {
				GET_PTRS_VALUE_hipGetDriverEntryPoint(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphExecGetFlags : {
				GET_PTRS_VALUE_hipGraphExecGetFlags(args);
				return;
			}
			...
			case HIP_API_ID_hipLaunchKernelExC : {
				GET_PTRS_VALUE_hipLaunchKernelExC(args);
				return;
			}
			...
			case HIP_API_ID_hipLibraryLoadData : {
				GET_PTRS_VALUE_hipLibraryLoadData(args);
				return;
			}
			...
			case HIP_API_ID_hipDeviceGetTexture1DLinearMaxWidth : {
				GET_PTRS_VALUE_hipDeviceGetTexture1DLinearMaxWidth(args);
				return;
			}
			...
			case HIP_API_ID_hipMemcpy3DBatchAsync : {
				GET_PTRS_VALUE_hipMemcpy3DBatchAsync(args);
				return;
			}
			...
			case HIP_API_ID_hipLinkCreate : {
				GET_PTRS_VALUE_hipLinkCreate(args);
				return;
			}
			...
			case HIP_API_ID_hipLinkComplete : {
				GET_PTRS_VALUE_hipLinkComplete(args);
				return;
			}
			...
			case HIP_API_ID_hipDrvGraphExecMemcpyNodeSetParams : {
				GET_PTRS_VALUE_hipDrvGraphExecMemcpyNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphNodeSetParams : {
				GET_PTRS_VALUE_hipGraphNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipLibraryLoadFromFile : {
				GET_PTRS_VALUE_hipLibraryLoadFromFile(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphAddBatchMemOpNode : {
				GET_PTRS_VALUE_hipGraphAddBatchMemOpNode(args);
				return;
			}
			...
			case HIP_API_ID_hipLinkAddData : {
				GET_PTRS_VALUE_hipLinkAddData(args);
				return;
			}
			...
			case HIP_API_ID_hipGetDriverEntryPoint_spt : {
				GET_PTRS_VALUE_hipGetDriverEntryPoint_spt(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphExecBatchMemOpNodeSetParams : {
				GET_PTRS_VALUE_hipGraphExecBatchMemOpNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipMemcpyBatchAsync : {
				GET_PTRS_VALUE_hipMemcpyBatchAsync(args);
				return;
			}
			...
			case HIP_API_ID_hipLibraryGetKernelCount : {
				GET_PTRS_VALUE_hipLibraryGetKernelCount(args);
				return;
			}
			...
			case HIP_API_ID_hipStreamGetAttribute : {
				GET_PTRS_VALUE_hipStreamGetAttribute(args);
				return;
			}
			...
			case HIP_API_ID_hipLibraryGetKernel : {
				GET_PTRS_VALUE_hipLibraryGetKernel(args);
				return;
			}
			...
			case HIP_API_ID_hipModuleGetFunctionCount : {
				GET_PTRS_VALUE_hipModuleGetFunctionCount(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphExecNodeSetParams : {
				GET_PTRS_VALUE_hipGraphExecNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipGraphBatchMemOpNodeGetParams : {
				GET_PTRS_VALUE_hipGraphBatchMemOpNodeGetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipDrvGraphMemcpyNodeSetParams : {
				GET_PTRS_VALUE_hipDrvGraphMemcpyNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipLinkAddFile : {
				GET_PTRS_VALUE_hipLinkAddFile(args);
				return;
			}
			case HIP_API_ID_hipDrvLaunchKernelEx : {
				GET_PTRS_VALUE_hipDrvLaunchKernelEx(args);
				return;
			}
			...
			case HIP_API_ID_hipMemcpy3DPeer : {
				GET_PTRS_VALUE_hipMemcpy3DPeer(args);
				return;
			}
			...
			case HIP_API_ID_hipStreamBatchMemOp : {
				GET_PTRS_VALUE_hipStreamBatchMemOp(args);
				return;
			}
			...
			case HIP_API_ID_hipDrvGraphMemcpyNodeGetParams : {
				GET_PTRS_VALUE_hipDrvGraphMemcpyNodeGetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipOccupancyAvailableDynamicSMemPerBlock : {
				GET_PTRS_VALUE_hipOccupancyAvailableDynamicSMemPerBlock(args);
				return;
			}
			...
			case HIP_API_ID_hipMemcpy3DPeerAsync : {
				GET_PTRS_VALUE_hipMemcpy3DPeerAsync(args);
				return;
			}
			...
			case HIP_API_ID_hipKernelGetName : {
				GET_PTRS_VALUE_hipKernelGetName(args);
				return;
			}
			...
			case HIP_API_ID_hipDrvGraphExecMemsetNodeSetParams : {
				GET_PTRS_VALUE_hipDrvGraphExecMemsetNodeSetParams(args);
				return;
			}
			...
			case HIP_API_ID_hipChooseDevice : {
				GET_PTRS_VALUE_hipChooseDevice(args);
				return;
			}
			case HIP_API_ID_hipExtModuleLaunchKernel : {
				GET_PTRS_VALUE_hipExtModuleLaunchKernel(args);
				return;
			}
			case HIP_API_ID_hipGetDeviceProperties : {
				GET_PTRS_VALUE_hipGetDeviceProperties(args);
				return;
			}
			case HIP_API_ID___hipRegisterFunction : {
				GET_PTRS_VALUE___hipRegisterFunction(args);
				return;
			}
			case HIP_API_ID___hipRegisterManagedVar : {
				GET_PTRS_VALUE___hipRegisterManagedVar(args);
				return;
			}
			case HIP_API_ID___hipRegisterVar : {
				GET_PTRS_VALUE___hipRegisterVar(args);
				return;
			}
			case HIP_API_ID___hipRegisterSurface : {
				GET_PTRS_VALUE___hipRegisterSurface(args);
				return;
			}
			case HIP_API_ID___hipRegisterTexture : {
				GET_PTRS_VALUE___hipRegisterTexture(args);
				return;
			}
            default : break;
        }
