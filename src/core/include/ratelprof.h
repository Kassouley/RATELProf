...
#include "domains/omp_tgt_api_helper.h"
 ...
 */
typedef enum {
	RATELPROF_DOMAIN_OMP_TGT, /**< Domain RATELPROF_DOMAIN_OMP_TGT. */
...
typedef struct ratelprof_api_activity_s {
     ...
     */
    union {
		omp_tgt_api_args_t omp_tgt_args;  /**< Args for OMP_TGT domain. */
 ...
 * @param activity A pointer to the API activity structure containing event details.
 */
...
/**
 * @extern omp_tgt_callback
 * @brief The callback handler for OMP_TGT domain.
 *
 * This external variable hold the "on enter" and "on exit" callbacks
 * for OMP_TGT functions.
 */        
extern api_callback_handler_t omp_tgt_callback;

/**
 * @extern hsa_callback
 * @brief The callback handler for HSA domain.
 *
 * This external variable hold the "on enter" and "on exit" callbacks
 * for HSA functions.
 */        
extern api_callback_handler_t hsa_callback;

/**
 * @extern omp_tgt_rtl_callback
 * @brief The callback handler for OMP_TGT_RTL domain.
 *
 * This external variable hold the "on enter" and "on exit" callbacks
 * for OMP_TGT_RTL functions.
 */        
extern api_callback_handler_t omp_tgt_rtl_callback;

/**
 * @extern hip_callback
 * @brief The callback handler for HIP domain.
 *
 * This external variable hold the "on enter" and "on exit" callbacks
 * for HIP functions.
 */        
extern api_callback_handler_t hip_callback; 


/**
 * @extern omp_tgt_api_table
 * @brief The API table for OMP_TGT domain.
 * 
 * This external variable hold the API table that contains information
 * about OMP_TGT functions.
 * It is used to manage and track the tracing of domain functions.
 */        
extern ratelprof_api_table_t omp_tgt_api_table;
