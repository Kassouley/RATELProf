...
ratelprof_status_t __ratelprof_enable_domain_impl(ratelprof_domain_t domain) {
    switch(domain) {
        case RATELPROF_DOMAIN_OMP_ROUTINE: return ratelprof_enable_api_table(&omp_routine_api_table, "RATELPROF_DOMAIN_OMP_ROUTINE_FUNCTIONS_FILTERED", "RATELPROF_DOMAIN_OMP_ROUTINE_FILTER_TYPE");
        case RATELPROF_DOMAIN_HSA: return ratelprof_enable_api_table(&hsa_api_table, "RATELPROF_DOMAIN_HSA_FUNCTIONS_FILTERED", "RATELPROF_DOMAIN_HSA_FILTER_TYPE");
        case RATELPROF_DOMAIN_OMP_TGT_RTL: return ratelprof_enable_api_table(&omp_tgt_rtl_api_table, "RATELPROF_DOMAIN_OMP_TGT_RTL_FUNCTIONS_FILTERED", "RATELPROF_DOMAIN_OMP_TGT_RTL_FILTER_TYPE");
        case RATELPROF_DOMAIN_HIP: return ratelprof_enable_api_table(&hip_api_table, "RATELPROF_DOMAIN_HIP_FUNCTIONS_FILTERED", "RATELPROF_DOMAIN_HIP_FILTER_TYPE");
...
ratelprof_status_t __ratelprof_disable_domain_impl(ratelprof_domain_t domain) {
    switch(domain) {
        case RATELPROF_DOMAIN_OMP_ROUTINE: return ratelprof_disable_api_table(&omp_routine_api_table);
        case RATELPROF_DOMAIN_HSA: return ratelprof_disable_api_table(&hsa_api_table);
        case RATELPROF_DOMAIN_OMP_TGT_RTL: return ratelprof_disable_api_table(&omp_tgt_rtl_api_table);
        case RATELPROF_DOMAIN_HIP: return ratelprof_disable_api_table(&hip_api_table);
        default: return RATELPROF_STATUS_UNKNOWN_DOMAIN;
    }
}
