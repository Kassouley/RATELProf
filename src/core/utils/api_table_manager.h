...
/**
 * Loads a shared library handle from the specified library path.
 * @param handle_lib_path The path to the shared library.
 * @return A handle to the loaded shared library, or NULL if the library cannot be found.
 */
