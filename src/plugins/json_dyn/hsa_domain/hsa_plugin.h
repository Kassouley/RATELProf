...
#define PROCESS_ARGS_hsa_ven_amd_pcs_create(args) { \
	...
	ratelprof_add_to_buffer(buf, "\"pc_sampling\":{\"type\":\"hsa_ven_amd_pcs_t *\",\"value\":{\"addr\":\"%p\"", args->hsa_ven_amd_pcs_create.pc_sampling); \
	if (args->hsa_ven_amd_pcs_create.pc_sampling != NULL) { \
		ratelprof_add_to_buffer(buf, ", \"->*\":{"); \
		ratelprof_add_to_buffer(buf, "\"handle\":{\"type\":\"uint64_t\",\"value\":\"%lu\"}", args->hsa_ven_amd_pcs_create.pc_sampling__ref.val.handle); \
		ratelprof_add_to_buffer(buf, "}"); \
	} \
	ratelprof_add_to_buffer(buf, "}},"); \
...
#define PROCESS_ARGS_hsa_ven_amd_pcs_create_from_id(args) { \
	...
	ratelprof_add_to_buffer(buf, "\"pc_sampling\":{\"type\":\"hsa_ven_amd_pcs_t *\",\"value\":{\"addr\":\"%p\"", args->hsa_ven_amd_pcs_create_from_id.pc_sampling); \
	if (args->hsa_ven_amd_pcs_create_from_id.pc_sampling != NULL) { \
		ratelprof_add_to_buffer(buf, ", \"->*\":{"); \
		ratelprof_add_to_buffer(buf, "\"handle\":{\"type\":\"uint64_t\",\"value\":\"%lu\"}", args->hsa_ven_amd_pcs_create_from_id.pc_sampling__ref.val.handle); \
		ratelprof_add_to_buffer(buf, "}"); \
	} \
	ratelprof_add_to_buffer(buf, "}},"); \
...
#define PROCESS_ARGS_hsa_amd_queue_get_info(args) { \
	ratelprof_add_to_buffer(buf, "\"queue\":{\"type\":\"hsa_queue_t *\",\"value\":{\"addr\":\"%p\"", args->hsa_amd_queue_get_info.queue); \
	if (args->hsa_amd_queue_get_info.queue != NULL) { \
		ratelprof_add_to_buffer(buf, ", \"->*\":{"); \
		ratelprof_add_to_buffer(buf, "\"type\":{\"type\":\"hsa_queue_type32_t\",\"value\":\"%u\"},", args->hsa_amd_queue_get_info.queue__ref.val.type); \
		ratelprof_add_to_buffer(buf, "\"features\":{\"type\":\"uint32_t\",\"value\":\"%u\"},", args->hsa_amd_queue_get_info.queue__ref.val.features); \
		ratelprof_add_to_buffer(buf, "\"doorbell_signal\":{\"type\":\"struct hsa_signal_t\",\"value\":{"); \
		ratelprof_add_to_buffer(buf, "\"handle\":{\"type\":\"uint64_t\",\"value\":\"%lu\"}", args->hsa_amd_queue_get_info.queue__ref.val.doorbell_signal.handle); \
		ratelprof_add_to_buffer(buf, "}},"); \
		ratelprof_add_to_buffer(buf, "\"size\":{\"type\":\"uint32_t\",\"value\":\"%u\"},", args->hsa_amd_queue_get_info.queue__ref.val.size); \
		ratelprof_add_to_buffer(buf, "\"reserved1\":{\"type\":\"uint32_t\",\"value\":\"%u\"},", args->hsa_amd_queue_get_info.queue__ref.val.reserved1); \
		ratelprof_add_to_buffer(buf, "\"id\":{\"type\":\"uint64_t\",\"value\":\"%lu\"}", args->hsa_amd_queue_get_info.queue__ref.val.id); \
		ratelprof_add_to_buffer(buf, "}"); \
	} \
	ratelprof_add_to_buffer(buf, "}},"); \
...
#define PROCESS_ARGS_hsa_amd_vmem_address_reserve_align(args) { \
	ratelprof_add_to_buffer(buf, "\"va\":{\"type\":\"void **\",\"value\":{\"addr\":\"%p\"", args->hsa_amd_vmem_address_reserve_align.va); \
	if (args->hsa_amd_vmem_address_reserve_align.va != NULL) { \
		ratelprof_add_to_buffer(buf, ",\"->*\":\"%p\"", args->hsa_amd_vmem_address_reserve_align.va__ref.ptr1); \
	} \
	ratelprof_add_to_buffer(buf, "}},"); \
