...
void process_omp_routine_args_for(omp_routine_api_id_t funid, const omp_routine_api_args_t* args, void* user_args) 
{
    ...
    switch(funid) {
		...
		case OMP_ROUTINE_API_ID_omp_target_memcpy_async :
			...
			add_to_json_buffer(buf, "\"depend\":{\"type\":\"omp_depend_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_async.depend);
		...
		case OMP_ROUTINE_API_ID_omp_target_memcpy_rect_async :
			...
			add_to_json_buffer(buf, "\"volume\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.volume);
			add_to_json_buffer(buf, "\"dst_offsets\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.dst_offsets);
			add_to_json_buffer(buf, "\"src_offsets\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.src_offsets);
			add_to_json_buffer(buf, "\"dst_dimensions\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.dst_dimensions);
			add_to_json_buffer(buf, "\"src_dimensions\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.src_dimensions);
			...
			add_to_json_buffer(buf, "\"depobj_list\":{\"type\":\"omp_depend_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect_async.depobj_list);
		...
		case OMP_ROUTINE_API_ID_omp_target_memcpy_rect :
			...
			add_to_json_buffer(buf, "\"volume\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect.volume);
			add_to_json_buffer(buf, "\"dst_offsets\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect.dst_offsets);
			add_to_json_buffer(buf, "\"src_offsets\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect.src_offsets);
			add_to_json_buffer(buf, "\"dst_dimensions\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect.dst_dimensions);
			add_to_json_buffer(buf, "\"src_dimensions\":{\"type\":\"const size_t *\",\"value\":\"%p\"},", args->omp_target_memcpy_rect.src_dimensions);
		...
		case OMP_ROUTINE_API_ID_omp_target_memset_async :
			...
			add_to_json_buffer(buf, "\"depend\":{\"type\":\"omp_depend_t *\",\"value\":\"%p\"},", args->omp_target_memset_async.depend);
		...
		case OMP_ROUTINE_API_ID_omp_get_interop_int :
			...
			add_to_json_buffer(buf, "\"exists\":{\"type\":\"int *\",\"value\":\"%p\"},", args->omp_get_interop_int.exists);
		...
		case OMP_ROUTINE_API_ID_omp_get_interop_name :
			...
			add_to_json_buffer(buf, "\"retval\":{\"type\":\"const char *\",\"value\":\"%p\"}", args->omp_get_interop_name.retval);
			break;
		...
		case OMP_ROUTINE_API_ID_omp_get_interop_ptr :
			...
			add_to_json_buffer(buf, "\"exists\":{\"type\":\"int *\",\"value\":\"%p\"},", args->omp_get_interop_ptr.exists);
		...
		case OMP_ROUTINE_API_ID_omp_get_interop_str :
			...
			add_to_json_buffer(buf, "\"exists\":{\"type\":\"int *\",\"value\":\"%p\"},", args->omp_get_interop_str.exists);
			add_to_json_buffer(buf, "\"retval\":{\"type\":\"const char *\",\"value\":\"%p\"}", args->omp_get_interop_str.retval);
			break;
		...
		case OMP_ROUTINE_API_ID_omp_get_interop_type_desc :
			...
			add_to_json_buffer(buf, "\"retval\":{\"type\":\"const char *\",\"value\":\"%p\"}", args->omp_get_interop_type_desc.retval);
			break;
