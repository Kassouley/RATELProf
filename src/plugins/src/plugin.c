...
ratelprof_status_t ratelprof_plugin_initialize(ratelprof_plugin_t** plugin) 
{
    ...
    *plugin = (ratelprof_plugin_t*)malloc(sizeof(ratelprof_plugin_t));
	...
	(*plugin)->omp_tgt_callback_handler.on_enter = on_enter_omp_tgt_callback;
	(*plugin)->omp_tgt_callback_handler.on_exit = on_exit_omp_tgt_callback;
	(*plugin)->hsa_callback_handler.on_enter = on_enter_hsa_callback;
	(*plugin)->hsa_callback_handler.on_exit = on_exit_hsa_callback;
	(*plugin)->omp_tgt_rtl_callback_handler.on_enter = on_enter_omp_tgt_rtl_callback;
	(*plugin)->omp_tgt_rtl_callback_handler.on_exit = on_exit_omp_tgt_rtl_callback;
	(*plugin)->hip_callback_handler.on_enter = on_enter_hip_callback;
	(*plugin)->hip_callback_handler.on_exit = on_exit_hip_callback; 
