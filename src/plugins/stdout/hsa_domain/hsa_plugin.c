...
void process_hsa_args_for(hsa_api_id_t funid, const hsa_api_args_t* args, ratelprof_buffer_t* buf){
    switch(funid) {
		...
		case HSA_API_ID_hsa_ven_amd_pcs_iterate_configuration : PROCESS_ARGS_hsa_ven_amd_pcs_iterate_configuration(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_start : PROCESS_ARGS_hsa_ven_amd_pcs_start(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_flush : PROCESS_ARGS_hsa_ven_amd_pcs_flush(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_create : PROCESS_ARGS_hsa_ven_amd_pcs_create(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_stop : PROCESS_ARGS_hsa_ven_amd_pcs_stop(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_create_from_id : PROCESS_ARGS_hsa_ven_amd_pcs_create_from_id(args); break;
		...
		case HSA_API_ID_hsa_amd_queue_get_info : PROCESS_ARGS_hsa_amd_queue_get_info(args); break;
		...
		case HSA_API_ID_hsa_amd_vmem_address_reserve_align : PROCESS_ARGS_hsa_amd_vmem_address_reserve_align(args); break;
		...
		case HSA_API_ID_hsa_ven_amd_pcs_destroy : PROCESS_ARGS_hsa_ven_amd_pcs_destroy(args); break;
