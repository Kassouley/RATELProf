...
hipError_t hipLibraryUnload(hipLibrary_t library) {
	return CALL(hipLibraryUnload, library, __builtin_return_address(0));
};
...
hipError_t hipStreamSetAttribute(hipStream_t stream, hipLaunchAttributeID attr, const hipLaunchAttributeValue * value) {
	return CALL(hipStreamSetAttribute, stream, attr, value, __builtin_return_address(0));
};
...
hipError_t hipStreamGetId(hipStream_t stream, unsigned long long * streamId) {
	return CALL(hipStreamGetId, stream, streamId, __builtin_return_address(0));
};
...
hipError_t hipKernelGetLibrary(hipLibrary_t * library, hipKernel_t kernel) {
	return CALL(hipKernelGetLibrary, library, kernel, __builtin_return_address(0));
};
...
hipError_t hipGraphBatchMemOpNodeSetParams(hipGraphNode_t hNode, hipBatchMemOpNodeParams * nodeParams) {
	return CALL(hipGraphBatchMemOpNodeSetParams, hNode, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipGetDriverEntryPoint(const char * symbol, void ** funcPtr, unsigned long long flags, hipDriverEntryPointQueryResult * driverStatus) {
	return CALL(hipGetDriverEntryPoint, symbol, funcPtr, flags, driverStatus, __builtin_return_address(0));
};
...
hipError_t hipGraphExecGetFlags(hipGraphExec_t graphExec, unsigned long long * flags) {
	return CALL(hipGraphExecGetFlags, graphExec, flags, __builtin_return_address(0));
};
...
hipError_t hipLaunchKernelExC(const hipLaunchConfig_t * config, const void * fPtr, void ** args) {
	return CALL(hipLaunchKernelExC, config, fPtr, args, __builtin_return_address(0));
};
...
hipError_t hipLibraryLoadData(hipLibrary_t * library, const void * code, hipJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, hipLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions) {
	return CALL(hipLibraryLoadData, library, code, jitOptions, jitOptionsValues, numJitOptions, libraryOptions, libraryOptionValues, numLibraryOptions, __builtin_return_address(0));
};
...
hipError_t hipDeviceGetTexture1DLinearMaxWidth(size_t * max_width, const hipChannelFormatDesc * desc, int device) {
	return CALL(hipDeviceGetTexture1DLinearMaxWidth, max_width, desc, device, __builtin_return_address(0));
};
...
hipError_t hipMemcpy3DBatchAsync(size_t numOps, struct hipMemcpy3DBatchOp * opList, size_t * failIdx, unsigned long long flags, hipStream_t stream) {
	return CALL(hipMemcpy3DBatchAsync, numOps, opList, failIdx, flags, stream, __builtin_return_address(0));
};
...
hipError_t hipLinkCreate(unsigned int numOptions, hipJitOption * options, void ** optionValues, hipLinkState_t * stateOut) {
	return CALL(hipLinkCreate, numOptions, options, optionValues, stateOut, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D16(hipDeviceptr_t dst, size_t dstPitch, unsigned short value, size_t width, size_t height) {
	return CALL(hipMemsetD2D16, dst, dstPitch, value, width, height, __builtin_return_address(0));
};
...
hipError_t hipLinkComplete(hipLinkState_t state, void ** hipBinOut, size_t * sizeOut) {
	return CALL(hipLinkComplete, state, hipBinOut, sizeOut, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D16Async(hipDeviceptr_t dst, size_t dstPitch, unsigned short value, size_t width, size_t height, hipStream_t stream) {
	return CALL(hipMemsetD2D16Async, dst, dstPitch, value, width, height, stream, __builtin_return_address(0));
};
...
hipError_t hipDrvGraphExecMemcpyNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const HIP_MEMCPY3D * copyParams, hipCtx_t ctx) {
	return CALL(hipDrvGraphExecMemcpyNodeSetParams, hGraphExec, hNode, copyParams, ctx, __builtin_return_address(0));
};
...
hipError_t hipStreamCopyAttributes(hipStream_t dst, hipStream_t src) {
	return CALL(hipStreamCopyAttributes, dst, src, __builtin_return_address(0));
};
...
hipError_t hipGraphNodeSetParams(hipGraphNode_t node, hipGraphNodeParams * nodeParams) {
	return CALL(hipGraphNodeSetParams, node, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D8Async(hipDeviceptr_t dst, size_t dstPitch, unsigned char value, size_t width, size_t height, hipStream_t stream) {
	return CALL(hipMemsetD2D8Async, dst, dstPitch, value, width, height, stream, __builtin_return_address(0));
};
...
hipError_t hipLibraryLoadFromFile(hipLibrary_t * library, const char * fileName, hipJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, hipLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions) {
	return CALL(hipLibraryLoadFromFile, library, fileName, jitOptions, jitOptionsValues, numJitOptions, libraryOptions, libraryOptionValues, numLibraryOptions, __builtin_return_address(0));
};
...
hipError_t hipGraphAddBatchMemOpNode(hipGraphNode_t * phGraphNode, hipGraph_t hGraph, const hipGraphNode_t * dependencies, size_t numDependencies, const hipBatchMemOpNodeParams * nodeParams) {
	return CALL(hipGraphAddBatchMemOpNode, phGraphNode, hGraph, dependencies, numDependencies, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D8(hipDeviceptr_t dst, size_t dstPitch, unsigned char value, size_t width, size_t height) {
	return CALL(hipMemsetD2D8, dst, dstPitch, value, width, height, __builtin_return_address(0));
};
...
hipError_t hipMemPrefetchAsync_v2(const void * dev_ptr, size_t count, hipMemLocation location, unsigned int flags, hipStream_t stream) {
	return CALL(hipMemPrefetchAsync_v2, dev_ptr, count, location, flags, stream, __builtin_return_address(0));
};
hipError_t hipLinkDestroy(hipLinkState_t state) {
	return CALL(hipLinkDestroy, state, __builtin_return_address(0));
};
...
hipError_t hipEventRecordWithFlags(hipEvent_t event, hipStream_t stream, unsigned int flags) {
	return CALL(hipEventRecordWithFlags, event, stream, flags, __builtin_return_address(0));
};
...
hipError_t hipLibraryEnumerateKernels(hipKernel_t * kernels, unsigned int numKernels, hipLibrary_t library) {
	return CALL(hipLibraryEnumerateKernels, kernels, numKernels, library, __builtin_return_address(0));
};
...
hipError_t hipLinkAddData(hipLinkState_t state, hipJitInputType type, void * data, size_t size, const char * name, unsigned int numOptions, hipJitOption * options, void ** optionValues) {
	return CALL(hipLinkAddData, state, type, data, size, name, numOptions, options, optionValues, __builtin_return_address(0));
};
...
hipError_t hipDrvGraphAddMemFreeNode(hipGraphNode_t * phGraphNode, hipGraph_t hGraph, const hipGraphNode_t * dependencies, size_t numDependencies, hipDeviceptr_t dptr) {
	return CALL(hipDrvGraphAddMemFreeNode, phGraphNode, hGraph, dependencies, numDependencies, dptr, __builtin_return_address(0));
};
...
hipError_t hipGetDriverEntryPoint_spt(const char * symbol, void ** funcPtr, unsigned long long flags, hipDriverEntryPointQueryResult * status) {
	return CALL(hipGetDriverEntryPoint_spt, symbol, funcPtr, flags, status, __builtin_return_address(0));
};
...
hipError_t hipGraphExecBatchMemOpNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const hipBatchMemOpNodeParams * nodeParams) {
	return CALL(hipGraphExecBatchMemOpNodeSetParams, hGraphExec, hNode, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipMemcpyBatchAsync(void ** dsts, void ** srcs, size_t * sizes, size_t count, hipMemcpyAttributes * attrs, size_t * attrsIdxs, size_t numAttrs, size_t * failIdx, hipStream_t stream) {
	return CALL(hipMemcpyBatchAsync, dsts, srcs, sizes, count, attrs, attrsIdxs, numAttrs, failIdx, stream, __builtin_return_address(0));
};
...
hipError_t hipMemGetHandleForAddressRange(void * handle, hipDeviceptr_t dptr, size_t size, hipMemRangeHandleType handleType, unsigned long long flags) {
	return CALL(hipMemGetHandleForAddressRange, handle, dptr, size, handleType, flags, __builtin_return_address(0));
};
...
hipError_t hipLibraryGetKernelCount(unsigned int * count, hipLibrary_t library) {
	return CALL(hipLibraryGetKernelCount, count, library, __builtin_return_address(0));
};
...
hipError_t hipStreamGetAttribute(hipStream_t stream, hipLaunchAttributeID attr, hipLaunchAttributeValue * value_out) {
	return CALL(hipStreamGetAttribute, stream, attr, value_out, __builtin_return_address(0));
};
...
hipError_t hipLibraryGetKernel(hipKernel_t * pKernel, hipLibrary_t library, const char * name) {
	return CALL(hipLibraryGetKernel, pKernel, library, name, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D32Async(hipDeviceptr_t dst, size_t dstPitch, unsigned int value, size_t width, size_t height, hipStream_t stream) {
	return CALL(hipMemsetD2D32Async, dst, dstPitch, value, width, height, stream, __builtin_return_address(0));
};
...
hipError_t hipModuleGetFunctionCount(unsigned int * count, hipModule_t mod) {
	return CALL(hipModuleGetFunctionCount, count, mod, __builtin_return_address(0));
};
...
hipError_t hipGraphExecNodeSetParams(hipGraphExec_t graphExec, hipGraphNode_t node, hipGraphNodeParams * nodeParams) {
	return CALL(hipGraphExecNodeSetParams, graphExec, node, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipGraphBatchMemOpNodeGetParams(hipGraphNode_t hNode, hipBatchMemOpNodeParams * nodeParams_out) {
	return CALL(hipGraphBatchMemOpNodeGetParams, hNode, nodeParams_out, __builtin_return_address(0));
};
...
hipError_t hipDrvGraphMemcpyNodeSetParams(hipGraphNode_t hNode, const HIP_MEMCPY3D * nodeParams) {
	return CALL(hipDrvGraphMemcpyNodeSetParams, hNode, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipLinkAddFile(hipLinkState_t state, hipJitInputType type, const char * path, unsigned int numOptions, hipJitOption * options, void ** optionValues) {
	return CALL(hipLinkAddFile, state, type, path, numOptions, options, optionValues, __builtin_return_address(0));
};
...
hipError_t hipDrvLaunchKernelEx(const HIP_LAUNCH_CONFIG * config, hipFunction_t f, void ** params, void ** extra) {
	return CALL(hipDrvLaunchKernelEx, config, f, params, extra, __builtin_return_address(0));
};
...
hipError_t hipMemcpy3DPeer(hipMemcpy3DPeerParms * p) {
	return CALL(hipMemcpy3DPeer, p, __builtin_return_address(0));
};
...
hipError_t hipStreamBatchMemOp(hipStream_t stream, unsigned int count, hipStreamBatchMemOpParams * paramArray, unsigned int flags) {
	return CALL(hipStreamBatchMemOp, stream, count, paramArray, flags, __builtin_return_address(0));
};
...
hipError_t hipMemsetD2D32(hipDeviceptr_t dst, size_t dstPitch, unsigned int value, size_t width, size_t height) {
	return CALL(hipMemsetD2D32, dst, dstPitch, value, width, height, __builtin_return_address(0));
};
hipError_t hipDrvGraphMemcpyNodeGetParams(hipGraphNode_t hNode, HIP_MEMCPY3D * nodeParams) {
	return CALL(hipDrvGraphMemcpyNodeGetParams, hNode, nodeParams, __builtin_return_address(0));
};
...
hipError_t hipOccupancyAvailableDynamicSMemPerBlock(size_t * dynamicSmemSize, const void * f, int numBlocks, int blockSize) {
	return CALL(hipOccupancyAvailableDynamicSMemPerBlock, dynamicSmemSize, f, numBlocks, blockSize, __builtin_return_address(0));
};
...
hipError_t hipModuleLoadFatBinary(hipModule_t * module, const void * fatbin) {
	return CALL(hipModuleLoadFatBinary, module, fatbin, __builtin_return_address(0));
};
...
hipError_t hipMemcpy3DPeerAsync(hipMemcpy3DPeerParms * p, hipStream_t stream) {
	return CALL(hipMemcpy3DPeerAsync, p, stream, __builtin_return_address(0));
};
...
hipError_t hipKernelGetName(const char ** name, hipKernel_t kernel) {
	return CALL(hipKernelGetName, name, kernel, __builtin_return_address(0));
};
...
hipError_t hipDrvGraphExecMemsetNodeSetParams(hipGraphExec_t hGraphExec, hipGraphNode_t hNode, const hipMemsetParams * memsetParams, hipCtx_t ctx) {
	return CALL(hipDrvGraphExecMemsetNodeSetParams, hGraphExec, hNode, memsetParams, ctx, __builtin_return_address(0));
};
...
hipError_t hipMemAdvise_v2(const void * dev_ptr, size_t count, hipMemoryAdvise advice, hipMemLocation location) {
	return CALL(hipMemAdvise_v2, dev_ptr, count, advice, location, __builtin_return_address(0));
};
...
hipError_t hipChooseDevice(int * device, const hipDeviceProp_t * prop) {
	return CALL(hipChooseDevice, device, prop, __builtin_return_address(0));
};
hipError_t hipExtModuleLaunchKernel(hipFunction_t f, uint32_t globalWorkSizeX, uint32_t globalWorkSizeY, uint32_t globalWorkSizeZ, uint32_t localWorkSizeX, uint32_t localWorkSizeY, uint32_t localWorkSizeZ, size_t sharedMemBytes, hipStream_t hStream, void ** kernelParams, void ** extra, hipEvent_t startEvent, hipEvent_t stopEvent, uint32_t flags) {
	return CALL(hipExtModuleLaunchKernel, f, globalWorkSizeX, globalWorkSizeY, globalWorkSizeZ, localWorkSizeX, localWorkSizeY, localWorkSizeZ, sharedMemBytes, hStream, kernelParams, extra, startEvent, stopEvent, flags, __builtin_return_address(0));
};
hipError_t hipGetDeviceProperties(hipDeviceProp_t * prop, int deviceId) {
	return CALL(hipGetDeviceProperties, prop, deviceId, __builtin_return_address(0));
};
// void* __hipRegisterFatBinary(const void* data) {
// 	return CALL(__hipRegisterFatBinary, data, __builtin_return_address(0));
// };
void __hipUnregisterFatBinary(void* module) {
	CALL(__hipUnregisterFatBinary, module, __builtin_return_address(0));
};
...
// 	CALL(__hipRegisterFunction, modules, hostFunction, deviceFunction, deviceName, threadLimit, tid, bid, blockDim, gridDim, wSize, __builtin_return_address(0));
// };
void __hipRegisterManagedVar(void* hipModule, void** pointer, void* init_value, const char* name, size_t size, unsigned int align) {
	CALL(__hipRegisterManagedVar, hipModule, pointer, init_value, name, size, align, __builtin_return_address(0));
};
void __hipRegisterVar(void** modules, void* var, char* hostVar, char* deviceVar, int ext, size_t size, int constant, int global) {
	CALL(__hipRegisterVar, modules, var, hostVar, deviceVar, ext, size, constant, global, __builtin_return_address(0));
};
void __hipRegisterSurface(void** modules, void* var, char* hostVar, char* deviceVar, int type, int ext) {
	CALL(__hipRegisterSurface, modules, var, hostVar, deviceVar, type, ext, __builtin_return_address(0));
};
void __hipRegisterTexture(void** modules, void* var, char* hostVar, char* deviceVar, int type, int norm, int ext) {
	CALL(__hipRegisterTexture, modules, var, hostVar, deviceVar, type, norm, ext, __builtin_return_address(0));
};