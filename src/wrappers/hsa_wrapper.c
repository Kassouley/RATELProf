...
hsa_status_t hsa_amd_ais_file_write(hsa_amd_ais_file_handle_t handle, void * devicePtr, uint64_t size, int64_t file_offset, uint64_t * size_copied, int32_t * status) {
	return CALL(hsa_amd_ais_file_write, handle, devicePtr, size, file_offset, size_copied, status, __builtin_return_address(0));
};
...
hsa_status_t hsa_amd_memory_get_preferred_copy_engine(hsa_agent_t dst_agent, hsa_agent_t src_agent, uint32_t * recommended_ids_mask) {
	return CALL(hsa_amd_memory_get_preferred_copy_engine, dst_agent, src_agent, recommended_ids_mask, __builtin_return_address(0));
};
...
hsa_status_t hsa_amd_portable_export_dmabuf_v2(const void * ptr, size_t size, int * dmabuf, uint64_t * offset, uint64_t flags) {
	return CALL(hsa_amd_portable_export_dmabuf_v2, ptr, size, dmabuf, offset, flags, __builtin_return_address(0));
};
...
hsa_status_t hsa_ext_sampler_create_v2(hsa_agent_t agent, const hsa_ext_sampler_descriptor_v2_t * sampler_descriptor, hsa_ext_sampler_t * sampler) {
	return CALL(hsa_ext_sampler_create_v2, agent, sampler_descriptor, sampler, __builtin_return_address(0));
};
...
hsa_status_t hsa_amd_enable_logging(uint8_t * flags, void * file) {
	return CALL(hsa_amd_enable_logging, flags, file, __builtin_return_address(0));
};
...
hsa_status_t hsa_amd_interop_map_buffer(uint32_t num_agents, hsa_agent_t * agents, hsa_handle_t interop_handle, uint32_t flags, size_t * size, void ** ptr, size_t * metadata_size, const void ** metadata) {
...
hsa_status_t hsa_amd_ais_file_read(hsa_amd_ais_file_handle_t handle, void * devicePtr, uint64_t size, int64_t file_offset, uint64_t * size_copied, int32_t * status) {
	return CALL(hsa_amd_ais_file_read, handle, devicePtr, size, file_offset, size_copied, status, __builtin_return_address(0));
};
...
uint32_t hsa_amd_signal_wait_all(uint32_t signal_count, hsa_signal_t * signals, hsa_signal_condition_t * conds, hsa_signal_value_t * values, uint64_t timeout_hint, hsa_wait_state_t wait_hint, hsa_signal_value_t * satisfying_values) {
	return CALL(hsa_amd_signal_wait_all, signal_count, signals, conds, values, timeout_hint, wait_hint, satisfying_values, __builtin_return_address(0));
};
